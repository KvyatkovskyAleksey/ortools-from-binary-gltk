if(NOT UNIX)
  execute_process(
    WORKING_DIRECTORY /build/or-tools/build/python
    COMMAND /usr/local/bin/python3.9 -m pip install
    --find-links=dist ortools==9.8.3309
  )
  return()
endif()

if(DEFINED ENV{DESTDIR})
  # If DESTDIR is not absolute path, make it relative to /build/or-tools/build
  # like any install() command.
  if(IS_ABSOLUTE $ENV{DESTDIR})
    set(ROOT "--root='$ENV{DESTDIR}'")
  else()
    set(ROOT "--root='/build/or-tools/build/$ENV{DESTDIR}'")
  endif()
else()
  set(ROOT "")
endif()
...
execute_process(
  COMMAND "/usr/local/bin/python3.9" -c "import sys; sys.stdout.write(sys.path[-1])"
...
execute_process(
  WORKING_DIRECTORY /build/or-tools/build/python
  COMMAND "/usr/local/bin/python3.9" setup.py install
    ${ROOT}
    --prefix="/usr/local"
