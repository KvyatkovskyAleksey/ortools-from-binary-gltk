...
class IntVarLocalSearchOperator(LocalSearchOperator):
    ...
    def __init__(self, vars: 'std::vector< operations_research::IntVar * > const &', keep_inverse_values: 'bool'=False):
        if self.__class__ == IntVarLocalSearchOperator:
            ...
            _self = self
        this = _pywrapcp.new_IntVarLocalSearchOperator(_self, vars, keep_inverse_values)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class LocalSearchFilterManager(BaseObject):
    ...
    for _s in [BaseObject]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, LocalSearchFilterManager, name, value)
    __swig_getmethods__ = {}
    for _s in [BaseObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, LocalSearchFilterManager, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _pywrapcp.new_LocalSearchFilterManager(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
LocalSearchFilterManager_swigregister = _pywrapcp.LocalSearchFilterManager_swigregister
LocalSearchFilterManager_swigregister(LocalSearchFilterManager)
...
class FirstSolutionStrategy(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, FirstSolutionStrategy, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, FirstSolutionStrategy, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = _pywrapcp.new_FirstSolutionStrategy()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
FirstSolutionStrategy_swigregister = _pywrapcp.FirstSolutionStrategy_swigregister
FirstSolutionStrategy_swigregister(FirstSolutionStrategy)

class LocalSearchMetaheuristic(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, LocalSearchMetaheuristic, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, LocalSearchMetaheuristic, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = _pywrapcp.new_LocalSearchMetaheuristic()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
LocalSearchMetaheuristic_swigregister = _pywrapcp.LocalSearchMetaheuristic_swigregister
LocalSearchMetaheuristic_swigregister(LocalSearchMetaheuristic)

class PathsMetadata(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, PathsMetadata, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, PathsMetadata, name)
    __repr__ = _swig_repr

    def __init__(self, manager: 'RoutingIndexManager'):
        this = _pywrapcp.new_PathsMetadata(manager)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
PathsMetadata_swigregister = _pywrapcp.PathsMetadata_swigregister
PathsMetadata_swigregister(PathsMetadata)
...
class RoutingModel(_object):
    ...
    def ArcIsMoreConstrainedThanArc(self, arg2: 'int64_t', to1: 'int64_t', to2: 'int64_t') -> "bool":
...
class BoundCost(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, BoundCost, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, BoundCost, name)
    __repr__ = _swig_repr
    __swig_setmethods__["bound"] = _pywrapcp.BoundCost_bound_set
    __swig_getmethods__["bound"] = _pywrapcp.BoundCost_bound_get
    if _newclass:
        bound = _swig_property(_pywrapcp.BoundCost_bound_get, _pywrapcp.BoundCost_bound_set)
    __swig_setmethods__["cost"] = _pywrapcp.BoundCost_cost_set
    __swig_getmethods__["cost"] = _pywrapcp.BoundCost_cost_get
    if _newclass:
        cost = _swig_property(_pywrapcp.BoundCost_cost_get, _pywrapcp.BoundCost_cost_set)

    def __init__(self, *args):
        this = _pywrapcp.new_BoundCost(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
BoundCost_swigregister = _pywrapcp.BoundCost_swigregister
BoundCost_swigregister(BoundCost)

class SimpleBoundCosts(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SimpleBoundCosts, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SimpleBoundCosts, name)
    __repr__ = _swig_repr

    def __init__(self, num_bounds: 'int', default_bound_cost: 'BoundCost'):
        this = _pywrapcp.new_SimpleBoundCosts(num_bounds, default_bound_cost)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
SimpleBoundCosts_swigregister = _pywrapcp.SimpleBoundCosts_swigregister
SimpleBoundCosts_swigregister(SimpleBoundCosts)
...
SolveModelWithSat = _pywrapcp.SolveModelWithSat
