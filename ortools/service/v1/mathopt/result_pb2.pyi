...
class SolveStatsProto(_message.Message):
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["barrier_iterations", b"barrier_iterations", "first_order_iterations", b"first_order_iterations", "node_count", b"node_count", "problem_status", b"problem_status", "simplex_iterations", b"simplex_iterations", "solve_time", b"solve_time"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class SolveResultProto(_message.Message):
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["solve_stats", b"solve_stats", "termination", b"termination"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["dual_rays", b"dual_rays", "primal_rays", b"primal_rays", "solutions", b"solutions", "solve_stats", b"solve_stats", "termination", b"termination"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
