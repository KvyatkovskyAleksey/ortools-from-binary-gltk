...
class Solver(_object):
    ...
    if _newclass:
        CreateSolver = staticmethod(_pywraplp.Solver_CreateSolver)
    else:
        CreateSolver = _pywraplp.Solver_CreateSolver
    if _newclass:
    ...
    def SolverVersion(self) -> "std::string":
    ...
    def LoadModelFromProtoKeepNames(self, input_model: 'operations_research::MPModelProto const &') -> "std::string":
...
Solver_CreateSolver = _pywraplp.Solver_CreateSolver
...
FindErrorInModelProto = _pywraplp.FindErrorInModelProto
