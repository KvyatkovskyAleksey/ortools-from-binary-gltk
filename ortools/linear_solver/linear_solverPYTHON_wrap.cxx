...
SWIGINTERN PyObject *_wrap_Solver_LoadModelFromProtoKeepNames(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "Solver_LoadModelFromProtoKeepNames", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_operations_research__MPSolver, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Variable_name(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    if (!PyObjAs(swig_obj[0], &arg1)) SWIG_fail;
  }
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "Solver_nodes", _wrap_Solver_nodes, METH_O, "\n"
		...
		""},
	 { "Solver_SolverVersion", _wrap_Solver_SolverVersion, METH_O, " Returns a string describing the underlying solver and its version."},
	 ...
	 { "Solver_LoadModelFromProtoKeepNames", _wrap_Solver_LoadModelFromProtoKeepNames, METH_VARARGS, NULL},
