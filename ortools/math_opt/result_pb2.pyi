...
from ortools.pdlp import solve_log_pb2 as _solve_log_pb2
...
class _FeasibilityStatusProtoEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_FeasibilityStatusProto.ValueType], _builtins.type):
...
"""Solver claims the problem is infeasible."""
Global___FeasibilityStatusProto: _TypeAlias = FeasibilityStatusProto  # noqa: Y015

class _TerminationReasonProto:
    ValueType = _typing.NewType("ValueType", _builtins.int)
    V: _TypeAlias = ValueType  # noqa: Y015

class _TerminationReasonProtoEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_TerminationReasonProto.ValueType], _builtins.type):
    DESCRIPTOR: _descriptor.EnumDescriptor
...
statuses defined above. No solution information is available.
"""
Global___TerminationReasonProto: _TypeAlias = TerminationReasonProto  # noqa: Y015

class _LimitProto:
    ValueType = _typing.NewType("ValueType", _builtins.int)
    V: _TypeAlias = ValueType  # noqa: Y015

class _LimitProtoEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_LimitProto.ValueType], _builtins.type):
    DESCRIPTOR: _descriptor.EnumDescriptor
...
TerminationProto.detail may contain additional information about the limit.
"""
Global___LimitProto: _TypeAlias = LimitProto  # noqa: Y015

@_typing.final
class ProblemStatusProto(_message.Message):
    ...
    PRIMAL_STATUS_FIELD_NUMBER: _builtins.int
    DUAL_STATUS_FIELD_NUMBER: _builtins.int
    PRIMAL_OR_DUAL_INFEASIBLE_FIELD_NUMBER: _builtins.int
    ...
    primal_or_dual_infeasible: _builtins.bool
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["dual_status", b"dual_status", "primal_or_dual_infeasible", b"primal_or_dual_infeasible", "primal_status", b"primal_status"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___ProblemStatusProto: _TypeAlias = ProblemStatusProto  # noqa: Y015

@_typing.final
class SolveStatsProto(_message.Message):
    DESCRIPTOR: _descriptor.Descriptor

    SOLVE_TIME_FIELD_NUMBER: _builtins.int
    BEST_PRIMAL_BOUND_FIELD_NUMBER: _builtins.int
    BEST_DUAL_BOUND_FIELD_NUMBER: _builtins.int
    PROBLEM_STATUS_FIELD_NUMBER: _builtins.int
    SIMPLEX_ITERATIONS_FIELD_NUMBER: _builtins.int
    BARRIER_ITERATIONS_FIELD_NUMBER: _builtins.int
    FIRST_ORDER_ITERATIONS_FIELD_NUMBER: _builtins.int
    NODE_COUNT_FIELD_NUMBER: _builtins.int
    @_builtins.property
    @_deprecated("""This field has been marked as deprecated using proto field options.""")
    def best_primal_bound(self) -> _builtins.float:
        """Deprecated in favor of ObjectiveBoundsProto.primal_bound found in
        TerminationProto.
        """

    @best_primal_bound.setter
    @_deprecated("""This field has been marked as deprecated using proto field options.""")
    def best_primal_bound(self, value: _builtins.float) -> None:
        """Deprecated in favor of ObjectiveBoundsProto.primal_bound found in
        TerminationProto.
        """
    ...
    @_builtins.property
    @_deprecated("""This field has been marked as deprecated using proto field options.""")
    def best_dual_bound(self) -> _builtins.float:
        """Deprecated in favor of ObjectiveBoundsProto.dual_bound found in
        TerminationProto.
        """

    @best_dual_bound.setter
    @_deprecated("""This field has been marked as deprecated using proto field options.""")
    def best_dual_bound(self, value: _builtins.float) -> None:
        """Deprecated in favor of ObjectiveBoundsProto.dual_bound found in
        TerminationProto.
        """
    ...
    first_order_iterations: _builtins.int
    node_count: _builtins.int
    @_builtins.property
    def solve_time(self) -> _duration_pb2.Duration:
    ...
    def __init__(
        self,
        *,
        solve_time: _duration_pb2.Duration | None = ...,
        best_primal_bound: _builtins.float = ...,
        best_dual_bound: _builtins.float = ...,
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["problem_status", b"problem_status", "solve_time", b"solve_time"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["barrier_iterations", b"barrier_iterations", "best_dual_bound", b"best_dual_bound", "best_primal_bound", b"best_primal_bound", "first_order_iterations", b"first_order_iterations", "node_count", b"node_count", "problem_status", b"problem_status", "simplex_iterations", b"simplex_iterations", "solve_time", b"solve_time"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___SolveStatsProto: _TypeAlias = SolveStatsProto  # noqa: Y015

@_typing.final
class ObjectiveBoundsProto(_message.Message):
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["dual_bound", b"dual_bound", "primal_bound", b"primal_bound"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___ObjectiveBoundsProto: _TypeAlias = ObjectiveBoundsProto  # noqa: Y015

@_typing.final
class TerminationProto(_message.Message):
    ...
    PROBLEM_STATUS_FIELD_NUMBER: _builtins.int
    OBJECTIVE_BOUNDS_FIELD_NUMBER: _builtins.int
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["objective_bounds", b"objective_bounds", "problem_status", b"problem_status"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["detail", b"detail", "limit", b"limit", "objective_bounds", b"objective_bounds", "problem_status", b"problem_status", "reason", b"reason"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___TerminationProto: _TypeAlias = TerminationProto  # noqa: Y015

@_typing.final
class SolveResultProto(_message.Message):
    ...
    @_typing.final
    class PdlpOutput(_message.Message):
        DESCRIPTOR: _descriptor.Descriptor

        CONVERGENCE_INFORMATION_FIELD_NUMBER: _builtins.int
        @_builtins.property
        def convergence_information(self) -> _solve_log_pb2.ConvergenceInformation: ...
        def __init__(
            self,
            *,
            convergence_information: _solve_log_pb2.ConvergenceInformation | None = ...,
        ) -> None: ...
        _HasFieldArgType: _TypeAlias = _typing.Literal["convergence_information", b"convergence_information"]  # noqa: Y015
        def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
        _ClearFieldArgType: _TypeAlias = _typing.Literal["convergence_information", b"convergence_information"]  # noqa: Y015
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

    TERMINATION_FIELD_NUMBER: _builtins.int
    SOLUTIONS_FIELD_NUMBER: _builtins.int
    PRIMAL_RAYS_FIELD_NUMBER: _builtins.int
    DUAL_RAYS_FIELD_NUMBER: _builtins.int
    SOLVE_STATS_FIELD_NUMBER: _builtins.int
    GSCIP_OUTPUT_FIELD_NUMBER: _builtins.int
    OSQP_OUTPUT_FIELD_NUMBER: _builtins.int
    PDLP_OUTPUT_FIELD_NUMBER: _builtins.int
    @_builtins.property
    def termination(self) -> Global___TerminationProto:
        """The reason the solver stopped."""

    @_builtins.property
    def solutions(self) -> _containers.RepeatedCompositeFieldContainer[_solution_pb2.SolutionProto]:
    ...
    @_builtins.property
    def primal_rays(self) -> _containers.RepeatedCompositeFieldContainer[_solution_pb2.PrimalRayProto]:
    ...
    @_builtins.property
    def dual_rays(self) -> _containers.RepeatedCompositeFieldContainer[_solution_pb2.DualRayProto]:
    ...
    @_builtins.property
    def gscip_output(self) -> _gscip_pb2.GScipOutput: ...
    @_builtins.property
    def osqp_output(self) -> _osqp_pb2.OsqpOutput: ...
    @_builtins.property
    ...
    def __init__(
        ...
        *,
        ...
        solutions: _abc.Iterable[_solution_pb2.SolutionProto] | None = ...,
        primal_rays: _abc.Iterable[_solution_pb2.PrimalRayProto] | None = ...,
        dual_rays: _abc.Iterable[_solution_pb2.DualRayProto] | None = ...,
        solve_stats: Global___SolveStatsProto | None = ...,
        gscip_output: _gscip_pb2.GScipOutput | None = ...,
        osqp_output: _osqp_pb2.OsqpOutput | None = ...,
        pdlp_output: Global___SolveResultProto.PdlpOutput | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["gscip_output", b"gscip_output", "osqp_output", b"osqp_output", "pdlp_output", b"pdlp_output", "solve_stats", b"solve_stats", "solver_specific_output", b"solver_specific_output", "termination", b"termination"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["dual_rays", b"dual_rays", "gscip_output", b"gscip_output", "osqp_output", b"osqp_output", "pdlp_output", b"pdlp_output", "primal_rays", b"primal_rays", "solutions", b"solutions", "solve_stats", b"solve_stats", "solver_specific_output", b"solver_specific_output", "termination", b"termination"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_solver_specific_output: _TypeAlias = _typing.Literal["gscip_output", "osqp_output", "pdlp_output"]  # noqa: Y015
    _WhichOneofArgType_solver_specific_output: _TypeAlias = _typing.Literal["solver_specific_output", b"solver_specific_output"]  # noqa: Y015
...
Global___SolveResultProto: _TypeAlias = SolveResultProto  # noqa: Y015
