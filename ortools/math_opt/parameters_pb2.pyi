...
from ortools.gscip import gscip_pb2 as _gscip_pb2
from ortools.math_opt.solvers import glpk_pb2 as _glpk_pb2
from ortools.math_opt.solvers import gurobi_pb2 as _gurobi_pb2
from ortools.math_opt.solvers import highs_pb2 as _highs_pb2
from ortools.math_opt.solvers import osqp_pb2 as _osqp_pb2
...
class _SolverTypeProtoEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_SolverTypeProto.ValueType], _builtins.type):
...
A fast option, but has special licensing.
"""
Global___SolverTypeProto: _TypeAlias = SolverTypeProto  # noqa: Y015

class _LPAlgorithmProto:
    ValueType = _typing.NewType("ValueType", _builtins.int)
    V: _TypeAlias = ValueType  # noqa: Y015

class _LPAlgorithmProtoEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_LPAlgorithmProto.ValueType], _builtins.type):
    DESCRIPTOR: _descriptor.EnumDescriptor
...
solution quality parameters (e.g., tolerances) and to validate solutions.
"""
Global___LPAlgorithmProto: _TypeAlias = LPAlgorithmProto  # noqa: Y015

class _EmphasisProto:
    ValueType = _typing.NewType("ValueType", _builtins.int)
    V: _TypeAlias = ValueType  # noqa: Y015

class _EmphasisProtoEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_EmphasisProto.ValueType], _builtins.type):
    DESCRIPTOR: _descriptor.EnumDescriptor
...
Global___EmphasisProto: _TypeAlias = EmphasisProto  # noqa: Y015

@_typing.final
class StrictnessProto(_message.Message):
    ...
    BAD_PARAMETER_FIELD_NUMBER: _builtins.int
    bad_parameter: _builtins.bool
    def __init__(
        self,
        *,
        bad_parameter: _builtins.bool = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["bad_parameter", b"bad_parameter"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___StrictnessProto: _TypeAlias = StrictnessProto  # noqa: Y015

@_typing.final
class SolverInitializerProto(_message.Message):
    ...
    GUROBI_FIELD_NUMBER: _builtins.int
    @_builtins.property
    def gurobi(self) -> _gurobi_pb2.GurobiInitializerProto: ...
    def __init__(
        self,
        *,
        gurobi: _gurobi_pb2.GurobiInitializerProto | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["gurobi", b"gurobi"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["gurobi", b"gurobi"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___SolverInitializerProto: _TypeAlias = SolverInitializerProto  # noqa: Y015

@_typing.final
class SolveParametersProto(_message.Message):
    ...
    NODE_LIMIT_FIELD_NUMBER: _builtins.int
    CUTOFF_LIMIT_FIELD_NUMBER: _builtins.int
    OBJECTIVE_LIMIT_FIELD_NUMBER: _builtins.int
    BEST_BOUND_LIMIT_FIELD_NUMBER: _builtins.int
    SOLUTION_LIMIT_FIELD_NUMBER: _builtins.int
    ENABLE_OUTPUT_FIELD_NUMBER: _builtins.int
    THREADS_FIELD_NUMBER: _builtins.int
    RANDOM_SEED_FIELD_NUMBER: _builtins.int
    ABSOLUTE_GAP_TOLERANCE_FIELD_NUMBER: _builtins.int
    RELATIVE_GAP_TOLERANCE_FIELD_NUMBER: _builtins.int
    ...
    GSCIP_FIELD_NUMBER: _builtins.int
    GUROBI_FIELD_NUMBER: _builtins.int
    GLOP_FIELD_NUMBER: _builtins.int
    CP_SAT_FIELD_NUMBER: _builtins.int
    PDLP_FIELD_NUMBER: _builtins.int
    OSQP_FIELD_NUMBER: _builtins.int
    GLPK_FIELD_NUMBER: _builtins.int
    HIGHS_FIELD_NUMBER: _builtins.int
    ...
    """
    best_bound_limit: _builtins.float
    ...
    """
    absolute_gap_tolerance: _builtins.float
    ...
    """
    relative_gap_tolerance: _builtins.float
    ...
    @_builtins.property
    def gscip(self) -> _gscip_pb2.GScipParameters:
        """////////////////////////////////////////////////////////////////////////////
    ...
    @_builtins.property
    def gurobi(self) -> _gurobi_pb2.GurobiParametersProto: ...
    @_builtins.property
    def glop(self) -> _parameters_pb2.GlopParameters: ...
    @_builtins.property
    def cp_sat(self) -> _sat_parameters_pb2.SatParameters: ...
    @_builtins.property
    def pdlp(self) -> _solvers_pb2.PrimalDualHybridGradientParams: ...
    @_builtins.property
    def osqp(self) -> _osqp_pb2.OsqpSettingsProto:
    ...
    @_builtins.property
    def glpk(self) -> _glpk_pb2.GlpkParametersProto: ...
    @_builtins.property
    def highs(self) -> _highs_pb2.HighsOptionsProto: ...
    def __init__(
        self,
        *,
        time_limit: _duration_pb2.Duration | None = ...,
        iteration_limit: _builtins.int | None = ...,
        node_limit: _builtins.int | None = ...,
        cutoff_limit: _builtins.float | None = ...,
        objective_limit: _builtins.float | None = ...,
        best_bound_limit: _builtins.float | None = ...,
        solution_limit: _builtins.int | None = ...,
        enable_output: _builtins.bool = ...,
        threads: _builtins.int | None = ...,
        random_seed: _builtins.int | None = ...,
        absolute_gap_tolerance: _builtins.float | None = ...,
        relative_gap_tolerance: _builtins.float | None = ...,
        ...
        heuristics: Global___EmphasisProto.ValueType = ...,
        scaling: Global___EmphasisProto.ValueType = ...,
        gscip: _gscip_pb2.GScipParameters | None = ...,
        gurobi: _gurobi_pb2.GurobiParametersProto | None = ...,
        glop: _parameters_pb2.GlopParameters | None = ...,
        cp_sat: _sat_parameters_pb2.SatParameters | None = ...,
        pdlp: _solvers_pb2.PrimalDualHybridGradientParams | None = ...,
        osqp: _osqp_pb2.OsqpSettingsProto | None = ...,
        glpk: _glpk_pb2.GlpkParametersProto | None = ...,
        highs: _highs_pb2.HighsOptionsProto | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["_absolute_gap_tolerance", b"_absolute_gap_tolerance", "_best_bound_limit", b"_best_bound_limit", "_cutoff_limit", b"_cutoff_limit", "_iteration_limit", b"_iteration_limit", "_node_limit", b"_node_limit", "_objective_limit", b"_objective_limit", "_random_seed", b"_random_seed", "_relative_gap_tolerance", b"_relative_gap_tolerance", "_solution_limit", b"_solution_limit", "_solution_pool_size", b"_solution_pool_size", "_threads", b"_threads", "absolute_gap_tolerance", b"absolute_gap_tolerance", "best_bound_limit", b"best_bound_limit", "cp_sat", b"cp_sat", "cutoff_limit", b"cutoff_limit", "glop", b"glop", "glpk", b"glpk", "gscip", b"gscip", "gurobi", b"gurobi", "highs", b"highs", "iteration_limit", b"iteration_limit", "node_limit", b"node_limit", "objective_limit", b"objective_limit", "osqp", b"osqp", "pdlp", b"pdlp", "random_seed", b"random_seed", "relative_gap_tolerance", b"relative_gap_tolerance", "solution_limit", b"solution_limit", "solution_pool_size", b"solution_pool_size", "threads", b"threads", "time_limit", b"time_limit"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["_absolute_gap_tolerance", b"_absolute_gap_tolerance", "_best_bound_limit", b"_best_bound_limit", "_cutoff_limit", b"_cutoff_limit", "_iteration_limit", b"_iteration_limit", "_node_limit", b"_node_limit", "_objective_limit", b"_objective_limit", "_random_seed", b"_random_seed", "_relative_gap_tolerance", b"_relative_gap_tolerance", "_solution_limit", b"_solution_limit", "_solution_pool_size", b"_solution_pool_size", "_threads", b"_threads", "absolute_gap_tolerance", b"absolute_gap_tolerance", "best_bound_limit", b"best_bound_limit", "cp_sat", b"cp_sat", "cutoff_limit", b"cutoff_limit", "cuts", b"cuts", "enable_output", b"enable_output", "glop", b"glop", "glpk", b"glpk", "gscip", b"gscip", "gurobi", b"gurobi", "heuristics", b"heuristics", "highs", b"highs", "iteration_limit", b"iteration_limit", "lp_algorithm", b"lp_algorithm", "node_limit", b"node_limit", "objective_limit", b"objective_limit", "osqp", b"osqp", "pdlp", b"pdlp", "presolve", b"presolve", "random_seed", b"random_seed", "relative_gap_tolerance", b"relative_gap_tolerance", "scaling", b"scaling", "solution_limit", b"solution_limit", "solution_pool_size", b"solution_pool_size", "threads", b"threads", "time_limit", b"time_limit"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType__absolute_gap_tolerance: _TypeAlias = _typing.Literal["absolute_gap_tolerance"]  # noqa: Y015
    _WhichOneofArgType__absolute_gap_tolerance: _TypeAlias = _typing.Literal["_absolute_gap_tolerance", b"_absolute_gap_tolerance"]  # noqa: Y015
    _WhichOneofReturnType__best_bound_limit: _TypeAlias = _typing.Literal["best_bound_limit"]  # noqa: Y015
    _WhichOneofArgType__best_bound_limit: _TypeAlias = _typing.Literal["_best_bound_limit", b"_best_bound_limit"]  # noqa: Y015
    _WhichOneofReturnType__cutoff_limit: _TypeAlias = _typing.Literal["cutoff_limit"]  # noqa: Y015
    _WhichOneofArgType__cutoff_limit: _TypeAlias = _typing.Literal["_cutoff_limit", b"_cutoff_limit"]  # noqa: Y015
    _WhichOneofReturnType__iteration_limit: _TypeAlias = _typing.Literal["iteration_limit"]  # noqa: Y015
    _WhichOneofArgType__iteration_limit: _TypeAlias = _typing.Literal["_iteration_limit", b"_iteration_limit"]  # noqa: Y015
    _WhichOneofReturnType__node_limit: _TypeAlias = _typing.Literal["node_limit"]  # noqa: Y015
    _WhichOneofArgType__node_limit: _TypeAlias = _typing.Literal["_node_limit", b"_node_limit"]  # noqa: Y015
    ...
    _WhichOneofReturnType__relative_gap_tolerance: _TypeAlias = _typing.Literal["relative_gap_tolerance"]  # noqa: Y015
    _WhichOneofArgType__relative_gap_tolerance: _TypeAlias = _typing.Literal["_relative_gap_tolerance", b"_relative_gap_tolerance"]  # noqa: Y015
    _WhichOneofReturnType__solution_limit: _TypeAlias = _typing.Literal["solution_limit"]  # noqa: Y015
    _WhichOneofArgType__solution_limit: _TypeAlias = _typing.Literal["_solution_limit", b"_solution_limit"]  # noqa: Y015
    _WhichOneofReturnType__solution_pool_size: _TypeAlias = _typing.Literal["solution_pool_size"]  # noqa: Y015
    _WhichOneofArgType__solution_pool_size: _TypeAlias = _typing.Literal["_solution_pool_size", b"_solution_pool_size"]  # noqa: Y015
    _WhichOneofReturnType__threads: _TypeAlias = _typing.Literal["threads"]  # noqa: Y015
    _WhichOneofArgType__threads: _TypeAlias = _typing.Literal["_threads", b"_threads"]  # noqa: Y015
    @_typing.overload
...
Global___SolveParametersProto: _TypeAlias = SolveParametersProto  # noqa: Y015
