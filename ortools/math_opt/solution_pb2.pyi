...
class DualSolutionProto(_message.Message):
    ...
    QUADRATIC_DUAL_VALUES_FIELD_NUMBER: _builtins.int
    ...
    @_builtins.property
    def quadratic_dual_values(self) -> _sparse_containers_pb2.SparseDoubleVectorProto:
        """Requirements:
    ...
    def __init__(
        ...
        *,
        ...
        quadratic_dual_values: _sparse_containers_pb2.SparseDoubleVectorProto | None = ...,
        reduced_costs: _sparse_containers_pb2.SparseDoubleVectorProto | None = ...,
        objective_value: _builtins.float | None = ...,
        feasibility_status: Global___SolutionStatusProto.ValueType = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["_objective_value", b"_objective_value", "dual_values", b"dual_values", "objective_value", b"objective_value", "quadratic_dual_values", b"quadratic_dual_values", "reduced_costs", b"reduced_costs"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["_objective_value", b"_objective_value", "dual_values", b"dual_values", "feasibility_status", b"feasibility_status", "objective_value", b"objective_value", "quadratic_dual_values", b"quadratic_dual_values", "reduced_costs", b"reduced_costs"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
