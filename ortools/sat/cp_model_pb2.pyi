...
class _CpSolverStatusEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_CpSolverStatus.ValueType], _builtins.type):
...
FEASIBLE.
"""
Global___CpSolverStatus: _TypeAlias = CpSolverStatus  # noqa: Y015

@_typing.final
class IntegerVariableProto(_message.Message):
    """An integer variable.
    ...
    @_builtins.property
    def domain(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
    ...
    def __init__(
        ...
        *,
        name: _builtins.str = ...,
        domain: _abc.Iterable[_builtins.int] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["domain", b"domain", "name", b"name"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___IntegerVariableProto: _TypeAlias = IntegerVariableProto  # noqa: Y015

@_typing.final
class BoolArgumentProto(_message.Message):
...
Global___BoolArgumentProto: _TypeAlias = BoolArgumentProto  # noqa: Y015
...
class LinearExpressionProto(_message.Message):
    ...
    COEFFS_FIELD_NUMBER: _builtins.int
    OFFSET_FIELD_NUMBER: _builtins.int
    offset: _builtins.int
    @_builtins.property
    def vars(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    @_builtins.property
    def coeffs(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    def __init__(
        self,
        *,
        vars: _abc.Iterable[_builtins.int] | None = ...,
        coeffs: _abc.Iterable[_builtins.int] | None = ...,
        offset: _builtins.int = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["coeffs", b"coeffs", "offset", b"offset", "vars", b"vars"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___LinearExpressionProto: _TypeAlias = LinearExpressionProto  # noqa: Y015

@_typing.final
class LinearArgumentProto(_message.Message):
    DESCRIPTOR: _descriptor.Descriptor
    ...
    @_builtins.property
    def exprs(self) -> _containers.RepeatedCompositeFieldContainer[Global___LinearExpressionProto]: ...
    def __init__(
        self,
        *,
        target: Global___LinearExpressionProto | None = ...,
        exprs: _abc.Iterable[Global___LinearExpressionProto] | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["target", b"target"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["exprs", b"exprs", "target", b"target"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___LinearArgumentProto: _TypeAlias = LinearArgumentProto  # noqa: Y015

@_typing.final
class AllDifferentConstraintProto(_message.Message):
...
Global___AllDifferentConstraintProto: _TypeAlias = AllDifferentConstraintProto  # noqa: Y015

@_typing.final
class LinearConstraintProto(_message.Message):
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["coeffs", b"coeffs", "domain", b"domain", "vars", b"vars"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___LinearConstraintProto: _TypeAlias = LinearConstraintProto  # noqa: Y015

@_typing.final
class ElementConstraintProto(_message.Message):
    ...
    TARGET_FIELD_NUMBER: _builtins.int
    VARS_FIELD_NUMBER: _builtins.int
    LINEAR_INDEX_FIELD_NUMBER: _builtins.int
    LINEAR_TARGET_FIELD_NUMBER: _builtins.int
    EXPRS_FIELD_NUMBER: _builtins.int
    index: _builtins.int
    """Legacy field."""
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["linear_index", b"linear_index", "linear_target", b"linear_target"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["exprs", b"exprs", "index", b"index", "linear_index", b"linear_index", "linear_target", b"linear_target", "target", b"target", "vars", b"vars"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___ElementConstraintProto: _TypeAlias = ElementConstraintProto  # noqa: Y015

@_typing.final
class IntervalConstraintProto(_message.Message):
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["end", b"end", "size", b"size", "start", b"start"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["end", b"end", "size", b"size", "start", b"start"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___IntervalConstraintProto: _TypeAlias = IntervalConstraintProto  # noqa: Y015

@_typing.final
class NoOverlapConstraintProto(_message.Message):
    ...
    @_builtins.property
    def intervals(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    def __init__(
        self,
        *,
        intervals: _abc.Iterable[_builtins.int] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["intervals", b"intervals"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___NoOverlapConstraintProto: _TypeAlias = NoOverlapConstraintProto  # noqa: Y015

@_typing.final
class NoOverlap2DConstraintProto(_message.Message):
    ...
    X_INTERVALS_FIELD_NUMBER: _builtins.int
    Y_INTERVALS_FIELD_NUMBER: _builtins.int
    @_builtins.property
    def x_intervals(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    @_builtins.property
    def y_intervals(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
        """Same size as x_intervals."""

    def __init__(
        self,
        *,
        x_intervals: _abc.Iterable[_builtins.int] | None = ...,
        y_intervals: _abc.Iterable[_builtins.int] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["x_intervals", b"x_intervals", "y_intervals", b"y_intervals"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___NoOverlap2DConstraintProto: _TypeAlias = NoOverlap2DConstraintProto  # noqa: Y015

@_typing.final
class CumulativeConstraintProto(_message.Message):
    ...
    def intervals(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    @_builtins.property
    def demands(self) -> _containers.RepeatedCompositeFieldContainer[Global___LinearExpressionProto]:
    ...
    def __init__(
        ...
        *,
        ...
        intervals: _abc.Iterable[_builtins.int] | None = ...,
        demands: _abc.Iterable[Global___LinearExpressionProto] | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["capacity", b"capacity"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["capacity", b"capacity", "demands", b"demands", "intervals", b"intervals"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___CumulativeConstraintProto: _TypeAlias = CumulativeConstraintProto  # noqa: Y015

@_typing.final
class ReservoirConstraintProto(_message.Message):
    ...
    MIN_LEVEL_FIELD_NUMBER: _builtins.int
    MAX_LEVEL_FIELD_NUMBER: _builtins.int
    TIME_EXPRS_FIELD_NUMBER: _builtins.int
    LEVEL_CHANGES_FIELD_NUMBER: _builtins.int
    ACTIVE_LITERALS_FIELD_NUMBER: _builtins.int
    min_level: _builtins.int
    max_level: _builtins.int
    @_builtins.property
    def time_exprs(self) -> _containers.RepeatedCompositeFieldContainer[Global___LinearExpressionProto]:
        """affine expressions."""

    @_builtins.property
    def level_changes(self) -> _containers.RepeatedCompositeFieldContainer[Global___LinearExpressionProto]:
        """Currently, we only support constant level changes.
        affine expressions.
        """

    @_builtins.property
    def active_literals(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    def __init__(
        self,
        *,
        min_level: _builtins.int = ...,
        max_level: _builtins.int = ...,
        time_exprs: _abc.Iterable[Global___LinearExpressionProto] | None = ...,
        level_changes: _abc.Iterable[Global___LinearExpressionProto] | None = ...,
        active_literals: _abc.Iterable[_builtins.int] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["active_literals", b"active_literals", "level_changes", b"level_changes", "max_level", b"max_level", "min_level", b"min_level", "time_exprs", b"time_exprs"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___ReservoirConstraintProto: _TypeAlias = ReservoirConstraintProto  # noqa: Y015

@_typing.final
class CircuitConstraintProto(_message.Message):
    ...
    TAILS_FIELD_NUMBER: _builtins.int
    HEADS_FIELD_NUMBER: _builtins.int
    LITERALS_FIELD_NUMBER: _builtins.int
    @_builtins.property
    def tails(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    @_builtins.property
    def heads(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    @_builtins.property
    def literals(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    def __init__(
        self,
        *,
        tails: _abc.Iterable[_builtins.int] | None = ...,
        heads: _abc.Iterable[_builtins.int] | None = ...,
        literals: _abc.Iterable[_builtins.int] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["heads", b"heads", "literals", b"literals", "tails", b"tails"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___CircuitConstraintProto: _TypeAlias = CircuitConstraintProto  # noqa: Y015

@_typing.final
class RoutesConstraintProto(_message.Message):
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["capacity", b"capacity", "demands", b"demands", "heads", b"heads", "literals", b"literals", "tails", b"tails"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___RoutesConstraintProto: _TypeAlias = RoutesConstraintProto  # noqa: Y015

@_typing.final
class TableConstraintProto(_message.Message):
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["exprs", b"exprs", "negated", b"negated", "values", b"values", "vars", b"vars"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___TableConstraintProto: _TypeAlias = TableConstraintProto  # noqa: Y015

@_typing.final
class InverseConstraintProto(_message.Message):
    ...
    F_DIRECT_FIELD_NUMBER: _builtins.int
    F_INVERSE_FIELD_NUMBER: _builtins.int
    @_builtins.property
    def f_direct(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    @_builtins.property
    def f_inverse(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    def __init__(
        self,
        *,
        f_direct: _abc.Iterable[_builtins.int] | None = ...,
        f_inverse: _abc.Iterable[_builtins.int] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["f_direct", b"f_direct", "f_inverse", b"f_inverse"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___InverseConstraintProto: _TypeAlias = InverseConstraintProto  # noqa: Y015

@_typing.final
class AutomatonConstraintProto(_message.Message):
    ...
    STARTING_STATE_FIELD_NUMBER: _builtins.int
    FINAL_STATES_FIELD_NUMBER: _builtins.int
    TRANSITION_TAIL_FIELD_NUMBER: _builtins.int
    TRANSITION_HEAD_FIELD_NUMBER: _builtins.int
    TRANSITION_LABEL_FIELD_NUMBER: _builtins.int
    VARS_FIELD_NUMBER: _builtins.int
    EXPRS_FIELD_NUMBER: _builtins.int
    starting_state: _builtins.int
    ...
    """
    @_builtins.property
    def final_states(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    @_builtins.property
    def transition_tail(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
    ...
    @_builtins.property
    def transition_head(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    @_builtins.property
    def transition_label(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    @_builtins.property
    def vars(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
        """Legacy field."""
    ...
    def __init__(
        ...
        *,
        starting_state: _builtins.int = ...,
        final_states: _abc.Iterable[_builtins.int] | None = ...,
        transition_tail: _abc.Iterable[_builtins.int] | None = ...,
        transition_head: _abc.Iterable[_builtins.int] | None = ...,
        transition_label: _abc.Iterable[_builtins.int] | None = ...,
        vars: _abc.Iterable[_builtins.int] | None = ...,
        exprs: _abc.Iterable[Global___LinearExpressionProto] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["exprs", b"exprs", "final_states", b"final_states", "starting_state", b"starting_state", "transition_head", b"transition_head", "transition_label", b"transition_label", "transition_tail", b"transition_tail", "vars", b"vars"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___AutomatonConstraintProto: _TypeAlias = AutomatonConstraintProto  # noqa: Y015

@_typing.final
class ListOfVariablesProto(_message.Message):
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["vars", b"vars"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___ListOfVariablesProto: _TypeAlias = ListOfVariablesProto  # noqa: Y015
...
class ConstraintProto(_message.Message):
    ...
    NAME_FIELD_NUMBER: _builtins.int
    ENFORCEMENT_LITERAL_FIELD_NUMBER: _builtins.int
    BOOL_OR_FIELD_NUMBER: _builtins.int
    BOOL_AND_FIELD_NUMBER: _builtins.int
    AT_MOST_ONE_FIELD_NUMBER: _builtins.int
    EXACTLY_ONE_FIELD_NUMBER: _builtins.int
    BOOL_XOR_FIELD_NUMBER: _builtins.int
    INT_DIV_FIELD_NUMBER: _builtins.int
    INT_MOD_FIELD_NUMBER: _builtins.int
    INT_PROD_FIELD_NUMBER: _builtins.int
    LIN_MAX_FIELD_NUMBER: _builtins.int
    LINEAR_FIELD_NUMBER: _builtins.int
    ALL_DIFF_FIELD_NUMBER: _builtins.int
    ...
    AUTOMATON_FIELD_NUMBER: _builtins.int
    INVERSE_FIELD_NUMBER: _builtins.int
    RESERVOIR_FIELD_NUMBER: _builtins.int
    INTERVAL_FIELD_NUMBER: _builtins.int
    NO_OVERLAP_FIELD_NUMBER: _builtins.int
    NO_OVERLAP_2D_FIELD_NUMBER: _builtins.int
    CUMULATIVE_FIELD_NUMBER: _builtins.int
    DUMMY_CONSTRAINT_FIELD_NUMBER: _builtins.int
    name: _builtins.str
    """For debug/logging only. Can be empty."""
    @_builtins.property
    def enforcement_literal(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
    ...
    def __init__(
        ...
        *,
        name: _builtins.str = ...,
        enforcement_literal: _abc.Iterable[_builtins.int] | None = ...,
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["all_diff", b"all_diff", "at_most_one", b"at_most_one", "automaton", b"automaton", "bool_and", b"bool_and", "bool_or", b"bool_or", "bool_xor", b"bool_xor", "circuit", b"circuit", "constraint", b"constraint", "cumulative", b"cumulative", "dummy_constraint", b"dummy_constraint", "element", b"element", "exactly_one", b"exactly_one", "int_div", b"int_div", "int_mod", b"int_mod", "int_prod", b"int_prod", "interval", b"interval", "inverse", b"inverse", "lin_max", b"lin_max", "linear", b"linear", "no_overlap", b"no_overlap", "no_overlap_2d", b"no_overlap_2d", "reservoir", b"reservoir", "routes", b"routes", "table", b"table"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["all_diff", b"all_diff", "at_most_one", b"at_most_one", "automaton", b"automaton", "bool_and", b"bool_and", "bool_or", b"bool_or", "bool_xor", b"bool_xor", "circuit", b"circuit", "constraint", b"constraint", "cumulative", b"cumulative", "dummy_constraint", b"dummy_constraint", "element", b"element", "enforcement_literal", b"enforcement_literal", "exactly_one", b"exactly_one", "int_div", b"int_div", "int_mod", b"int_mod", "int_prod", b"int_prod", "interval", b"interval", "inverse", b"inverse", "lin_max", b"lin_max", "linear", b"linear", "name", b"name", "no_overlap", b"no_overlap", "no_overlap_2d", b"no_overlap_2d", "reservoir", b"reservoir", "routes", b"routes", "table", b"table"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_constraint: _TypeAlias = _typing.Literal["bool_or", "bool_and", "at_most_one", "exactly_one", "bool_xor", "int_div", "int_mod", "int_prod", "lin_max", "linear", "all_diff", "element", "circuit", "routes", "table", "automaton", "inverse", "reservoir", "interval", "no_overlap", "no_overlap_2d", "cumulative", "dummy_constraint"]  # noqa: Y015
    _WhichOneofArgType_constraint: _TypeAlias = _typing.Literal["constraint", b"constraint"]  # noqa: Y015
    def WhichOneof(self, oneof_group: _WhichOneofArgType_constraint) -> _WhichOneofReturnType_constraint | None: ...

Global___ConstraintProto: _TypeAlias = ConstraintProto  # noqa: Y015
...
class CpObjectiveProto(_message.Message):
    ...
    DOMAIN_FIELD_NUMBER: _builtins.int
    SCALING_WAS_EXACT_FIELD_NUMBER: _builtins.int
    INTEGER_BEFORE_OFFSET_FIELD_NUMBER: _builtins.int
    INTEGER_AFTER_OFFSET_FIELD_NUMBER: _builtins.int
    INTEGER_SCALING_FACTOR_FIELD_NUMBER: _builtins.int
    ...
    scaling_was_exact: _builtins.bool
    ...
    """
    integer_before_offset: _builtins.int
    ...
    """
    integer_after_offset: _builtins.int
    integer_scaling_factor: _builtins.int
    @_builtins.property
    def vars(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["coeffs", b"coeffs", "domain", b"domain", "integer_after_offset", b"integer_after_offset", "integer_before_offset", b"integer_before_offset", "integer_scaling_factor", b"integer_scaling_factor", "offset", b"offset", "scaling_factor", b"scaling_factor", "scaling_was_exact", b"scaling_was_exact", "vars", b"vars"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___CpObjectiveProto: _TypeAlias = CpObjectiveProto  # noqa: Y015

@_typing.final
class FloatObjectiveProto(_message.Message):
    ...
    def vars(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    @_builtins.property
    def coeffs(self) -> _containers.RepeatedScalarFieldContainer[_builtins.float]: ...
    def __init__(
        self,
        *,
        vars: _abc.Iterable[_builtins.int] | None = ...,
        coeffs: _abc.Iterable[_builtins.float] | None = ...,
        offset: _builtins.float = ...,
        maximize: _builtins.bool = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["coeffs", b"coeffs", "maximize", b"maximize", "offset", b"offset", "vars", b"vars"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___FloatObjectiveProto: _TypeAlias = FloatObjectiveProto  # noqa: Y015

@_typing.final
class DecisionStrategyProto(_message.Message):
    ...
    class _VariableSelectionStrategyEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[DecisionStrategyProto._VariableSelectionStrategy.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _DomainReductionStrategyEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[DecisionStrategyProto._DomainReductionStrategy.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    EXPRS_FIELD_NUMBER: _builtins.int
    VARIABLE_SELECTION_STRATEGY_FIELD_NUMBER: _builtins.int
    DOMAIN_REDUCTION_STRATEGY_FIELD_NUMBER: _builtins.int
    ...
    @_builtins.property
    def variables(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
    ...
    def __init__(
        self,
        *,
        variables: _abc.Iterable[_builtins.int] | None = ...,
        exprs: _abc.Iterable[Global___LinearExpressionProto] | None = ...,
        variable_selection_strategy: Global___DecisionStrategyProto.VariableSelectionStrategy.ValueType = ...,
        domain_reduction_strategy: Global___DecisionStrategyProto.DomainReductionStrategy.ValueType = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["domain_reduction_strategy", b"domain_reduction_strategy", "exprs", b"exprs", "variable_selection_strategy", b"variable_selection_strategy", "variables", b"variables"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___DecisionStrategyProto: _TypeAlias = DecisionStrategyProto  # noqa: Y015
...
class PartialVariableAssignment(_message.Message):
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["values", b"values", "vars", b"vars"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___PartialVariableAssignment: _TypeAlias = PartialVariableAssignment  # noqa: Y015

@_typing.final
class SparsePermutationProto(_message.Message):
    ...
    CYCLE_SIZES_FIELD_NUMBER: _builtins.int
    @_builtins.property
    def support(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
    ...
    @_builtins.property
    def cycle_sizes(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    def __init__(
        self,
        *,
        support: _abc.Iterable[_builtins.int] | None = ...,
        cycle_sizes: _abc.Iterable[_builtins.int] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["cycle_sizes", b"cycle_sizes", "support", b"support"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___SparsePermutationProto: _TypeAlias = SparsePermutationProto  # noqa: Y015

@_typing.final
class DenseMatrixProto(_message.Message):
    ...
    NUM_COLS_FIELD_NUMBER: _builtins.int
    ENTRIES_FIELD_NUMBER: _builtins.int
    num_rows: _builtins.int
    num_cols: _builtins.int
    @_builtins.property
    def entries(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]: ...
    def __init__(
        self,
        *,
        num_rows: _builtins.int = ...,
        num_cols: _builtins.int = ...,
        entries: _abc.Iterable[_builtins.int] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["entries", b"entries", "num_cols", b"num_cols", "num_rows", b"num_rows"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___DenseMatrixProto: _TypeAlias = DenseMatrixProto  # noqa: Y015

@_typing.final
class SymmetryProto(_message.Message):
    ...
    PERMUTATIONS_FIELD_NUMBER: _builtins.int
    ORBITOPES_FIELD_NUMBER: _builtins.int
    @_builtins.property
    def permutations(self) -> _containers.RepeatedCompositeFieldContainer[Global___SparsePermutationProto]:
    ...
    @_builtins.property
    def orbitopes(self) -> _containers.RepeatedCompositeFieldContainer[Global___DenseMatrixProto]:
    ...
    def __init__(
        self,
        *,
        permutations: _abc.Iterable[Global___SparsePermutationProto] | None = ...,
        orbitopes: _abc.Iterable[Global___DenseMatrixProto] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["orbitopes", b"orbitopes", "permutations", b"permutations"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___SymmetryProto: _TypeAlias = SymmetryProto  # noqa: Y015
...
class CpModelProto(_message.Message):
    ...
    FLOATING_POINT_OBJECTIVE_FIELD_NUMBER: _builtins.int
    SEARCH_STRATEGY_FIELD_NUMBER: _builtins.int
    SOLUTION_HINT_FIELD_NUMBER: _builtins.int
    ASSUMPTIONS_FIELD_NUMBER: _builtins.int
    SYMMETRY_FIELD_NUMBER: _builtins.int
    name: _builtins.str
    """For debug/logging only. Can be empty."""
    @_builtins.property
    def variables(self) -> _containers.RepeatedCompositeFieldContainer[Global___IntegerVariableProto]:
        """The associated Protos should be referred by their index in these fields."""

    @_builtins.property
    def constraints(self) -> _containers.RepeatedCompositeFieldContainer[Global___ConstraintProto]: ...
    @_builtins.property
    ...
    @_builtins.property
    def search_strategy(self) -> _containers.RepeatedCompositeFieldContainer[Global___DecisionStrategyProto]:
    ...
    @_builtins.property
    def assumptions(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
    ...
    def __init__(
        ...
        *,
        name: _builtins.str = ...,
        variables: _abc.Iterable[Global___IntegerVariableProto] | None = ...,
        constraints: _abc.Iterable[Global___ConstraintProto] | None = ...,
        objective: Global___CpObjectiveProto | None = ...,
        floating_point_objective: Global___FloatObjectiveProto | None = ...,
        search_strategy: _abc.Iterable[Global___DecisionStrategyProto] | None = ...,
        solution_hint: Global___PartialVariableAssignment | None = ...,
        assumptions: _abc.Iterable[_builtins.int] | None = ...,
        symmetry: Global___SymmetryProto | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["floating_point_objective", b"floating_point_objective", "objective", b"objective", "solution_hint", b"solution_hint", "symmetry", b"symmetry"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["assumptions", b"assumptions", "constraints", b"constraints", "floating_point_objective", b"floating_point_objective", "name", b"name", "objective", b"objective", "search_strategy", b"search_strategy", "solution_hint", b"solution_hint", "symmetry", b"symmetry", "variables", b"variables"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___CpModelProto: _TypeAlias = CpModelProto  # noqa: Y015

@_typing.final
class CpSolverSolution(_message.Message):
...
Global___CpSolverSolution: _TypeAlias = CpSolverSolution  # noqa: Y015

@_typing.final
class CpSolverResponse(_message.Message):
    ...
    SOLUTION_FIELD_NUMBER: _builtins.int
    ...
    TIGHTENED_VARIABLES_FIELD_NUMBER: _builtins.int
    SUFFICIENT_ASSUMPTIONS_FOR_INFEASIBILITY_FIELD_NUMBER: _builtins.int
    INTEGER_OBJECTIVE_FIELD_NUMBER: _builtins.int
    INNER_OBJECTIVE_LOWER_BOUND_FIELD_NUMBER: _builtins.int
    NUM_INTEGERS_FIELD_NUMBER: _builtins.int
    NUM_BOOLEANS_FIELD_NUMBER: _builtins.int
    NUM_FIXED_BOOLEANS_FIELD_NUMBER: _builtins.int
    NUM_CONFLICTS_FIELD_NUMBER: _builtins.int
    NUM_BRANCHES_FIELD_NUMBER: _builtins.int
    NUM_BINARY_PROPAGATIONS_FIELD_NUMBER: _builtins.int
    NUM_INTEGER_PROPAGATIONS_FIELD_NUMBER: _builtins.int
    NUM_RESTARTS_FIELD_NUMBER: _builtins.int
    NUM_LP_ITERATIONS_FIELD_NUMBER: _builtins.int
    WALL_TIME_FIELD_NUMBER: _builtins.int
    USER_TIME_FIELD_NUMBER: _builtins.int
    DETERMINISTIC_TIME_FIELD_NUMBER: _builtins.int
    GAP_INTEGRAL_FIELD_NUMBER: _builtins.int
    SOLUTION_INFO_FIELD_NUMBER: _builtins.int
    SOLVE_LOG_FIELD_NUMBER: _builtins.int
    ...
    """
    inner_objective_lower_bound: _builtins.int
    """Advanced usage.
    ...
    """
    num_booleans: _builtins.int
    num_fixed_booleans: _builtins.int
    num_conflicts: _builtins.int
    num_branches: _builtins.int
    num_binary_propagations: _builtins.int
    num_integer_propagations: _builtins.int
    num_restarts: _builtins.int
    num_lp_iterations: _builtins.int
    wall_time: _builtins.float
    """The time counted from the beginning of the Solve() call."""
    user_time: _builtins.float
    deterministic_time: _builtins.float
    gap_integral: _builtins.float
    """The integral of log(1 + absolute_objective_gap) over time."""
    solution_info: _builtins.str
    ...
    """
    solve_log: _builtins.str
    """The solve log will be filled if the parameter log_to_response is set to
    true.
    """
    @_builtins.property
    def solution(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
    ...
    @_builtins.property
    def additional_solutions(self) -> _containers.RepeatedCompositeFieldContainer[Global___CpSolverSolution]:
    ...
    @_builtins.property
    def tightened_variables(self) -> _containers.RepeatedCompositeFieldContainer[Global___IntegerVariableProto]:
        """Advanced usage.
    ...
    @_builtins.property
    def sufficient_assumptions_for_infeasibility(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
    ...
    def __init__(
        ...
        *,
        status: Global___CpSolverStatus.ValueType = ...,
        solution: _abc.Iterable[_builtins.int] | None = ...,
        objective_value: _builtins.float = ...,
        best_objective_bound: _builtins.float = ...,
        additional_solutions: _abc.Iterable[Global___CpSolverSolution] | None = ...,
        tightened_variables: _abc.Iterable[Global___IntegerVariableProto] | None = ...,
        sufficient_assumptions_for_infeasibility: _abc.Iterable[_builtins.int] | None = ...,
