...
@_typing.final
class SatParameters(_message.Message):
    ...
    class _VariableOrderEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._VariableOrder.ValueType], _builtins.type):
    ...
    class _PolarityEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._Polarity.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _ConflictMinimizationAlgorithmEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._ConflictMinimizationAlgorithm.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _BinaryMinizationAlgorithmEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._BinaryMinizationAlgorithm.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _ClauseProtectionEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._ClauseProtection.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _ClauseOrderingEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._ClauseOrdering.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _RestartAlgorithmEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._RestartAlgorithm.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _MaxSatAssumptionOrderEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._MaxSatAssumptionOrder.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _MaxSatStratificationAlgorithmEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._MaxSatStratificationAlgorithm.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _SearchBranchingEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._SearchBranching.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _SharedTreeSplitStrategyEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._SharedTreeSplitStrategy.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _FPRoundingMethodEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[SatParameters._FPRoundingMethod.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    PREFERRED_VARIABLE_ORDER_FIELD_NUMBER: _builtins.int
    INITIAL_POLARITY_FIELD_NUMBER: _builtins.int
    USE_PHASE_SAVING_FIELD_NUMBER: _builtins.int
    POLARITY_REPHASE_INCREMENT_FIELD_NUMBER: _builtins.int
    POLARITY_EXPLOIT_LS_HINTS_FIELD_NUMBER: _builtins.int
    RANDOM_POLARITY_RATIO_FIELD_NUMBER: _builtins.int
    RANDOM_BRANCHES_RATIO_FIELD_NUMBER: _builtins.int
    USE_ERWA_HEURISTIC_FIELD_NUMBER: _builtins.int
    INITIAL_VARIABLES_ACTIVITY_FIELD_NUMBER: _builtins.int
    ALSO_BUMP_VARIABLES_IN_CONFLICT_REASONS_FIELD_NUMBER: _builtins.int
    MINIMIZATION_ALGORITHM_FIELD_NUMBER: _builtins.int
    BINARY_MINIMIZATION_ALGORITHM_FIELD_NUMBER: _builtins.int
    SUBSUMPTION_DURING_CONFLICT_ANALYSIS_FIELD_NUMBER: _builtins.int
    CLAUSE_CLEANUP_PERIOD_FIELD_NUMBER: _builtins.int
    CLAUSE_CLEANUP_TARGET_FIELD_NUMBER: _builtins.int
    CLAUSE_CLEANUP_RATIO_FIELD_NUMBER: _builtins.int
    CLAUSE_CLEANUP_PROTECTION_FIELD_NUMBER: _builtins.int
    CLAUSE_CLEANUP_LBD_BOUND_FIELD_NUMBER: _builtins.int
    CLAUSE_CLEANUP_ORDERING_FIELD_NUMBER: _builtins.int
    PB_CLEANUP_INCREMENT_FIELD_NUMBER: _builtins.int
    PB_CLEANUP_RATIO_FIELD_NUMBER: _builtins.int
    VARIABLE_ACTIVITY_DECAY_FIELD_NUMBER: _builtins.int
    MAX_VARIABLE_ACTIVITY_VALUE_FIELD_NUMBER: _builtins.int
    GLUCOSE_MAX_DECAY_FIELD_NUMBER: _builtins.int
    GLUCOSE_DECAY_INCREMENT_FIELD_NUMBER: _builtins.int
    GLUCOSE_DECAY_INCREMENT_PERIOD_FIELD_NUMBER: _builtins.int
    CLAUSE_ACTIVITY_DECAY_FIELD_NUMBER: _builtins.int
    MAX_CLAUSE_ACTIVITY_VALUE_FIELD_NUMBER: _builtins.int
    RESTART_ALGORITHMS_FIELD_NUMBER: _builtins.int
    DEFAULT_RESTART_ALGORITHMS_FIELD_NUMBER: _builtins.int
    RESTART_PERIOD_FIELD_NUMBER: _builtins.int
    RESTART_RUNNING_WINDOW_SIZE_FIELD_NUMBER: _builtins.int
    RESTART_DL_AVERAGE_RATIO_FIELD_NUMBER: _builtins.int
    RESTART_LBD_AVERAGE_RATIO_FIELD_NUMBER: _builtins.int
    USE_BLOCKING_RESTART_FIELD_NUMBER: _builtins.int
    BLOCKING_RESTART_WINDOW_SIZE_FIELD_NUMBER: _builtins.int
    BLOCKING_RESTART_MULTIPLIER_FIELD_NUMBER: _builtins.int
    NUM_CONFLICTS_BEFORE_STRATEGY_CHANGES_FIELD_NUMBER: _builtins.int
    STRATEGY_CHANGE_INCREASE_RATIO_FIELD_NUMBER: _builtins.int
    MAX_TIME_IN_SECONDS_FIELD_NUMBER: _builtins.int
    MAX_DETERMINISTIC_TIME_FIELD_NUMBER: _builtins.int
    MAX_NUM_DETERMINISTIC_BATCHES_FIELD_NUMBER: _builtins.int
    MAX_NUMBER_OF_CONFLICTS_FIELD_NUMBER: _builtins.int
    MAX_MEMORY_IN_MB_FIELD_NUMBER: _builtins.int
    ABSOLUTE_GAP_LIMIT_FIELD_NUMBER: _builtins.int
    RELATIVE_GAP_LIMIT_FIELD_NUMBER: _builtins.int
    RANDOM_SEED_FIELD_NUMBER: _builtins.int
    PERMUTE_VARIABLE_RANDOMLY_FIELD_NUMBER: _builtins.int
    PERMUTE_PRESOLVE_CONSTRAINT_ORDER_FIELD_NUMBER: _builtins.int
    USE_ABSL_RANDOM_FIELD_NUMBER: _builtins.int
    LOG_SEARCH_PROGRESS_FIELD_NUMBER: _builtins.int
    LOG_SUBSOLVER_STATISTICS_FIELD_NUMBER: _builtins.int
    LOG_PREFIX_FIELD_NUMBER: _builtins.int
    LOG_TO_STDOUT_FIELD_NUMBER: _builtins.int
    LOG_TO_RESPONSE_FIELD_NUMBER: _builtins.int
    USE_PB_RESOLUTION_FIELD_NUMBER: _builtins.int
    MINIMIZE_REDUCTION_DURING_PB_RESOLUTION_FIELD_NUMBER: _builtins.int
    COUNT_ASSUMPTION_LEVELS_IN_LBD_FIELD_NUMBER: _builtins.int
    PRESOLVE_BVE_THRESHOLD_FIELD_NUMBER: _builtins.int
    PRESOLVE_BVE_CLAUSE_WEIGHT_FIELD_NUMBER: _builtins.int
    PROBING_DETERMINISTIC_TIME_LIMIT_FIELD_NUMBER: _builtins.int
    PRESOLVE_PROBING_DETERMINISTIC_TIME_LIMIT_FIELD_NUMBER: _builtins.int
    PRESOLVE_BLOCKED_CLAUSE_FIELD_NUMBER: _builtins.int
    PRESOLVE_USE_BVA_FIELD_NUMBER: _builtins.int
    PRESOLVE_BVA_THRESHOLD_FIELD_NUMBER: _builtins.int
    MAX_PRESOLVE_ITERATIONS_FIELD_NUMBER: _builtins.int
    CP_MODEL_PRESOLVE_FIELD_NUMBER: _builtins.int
    CP_MODEL_PROBING_LEVEL_FIELD_NUMBER: _builtins.int
    CP_MODEL_USE_SAT_PRESOLVE_FIELD_NUMBER: _builtins.int
    REMOVE_FIXED_VARIABLES_EARLY_FIELD_NUMBER: _builtins.int
    DETECT_TABLE_WITH_COST_FIELD_NUMBER: _builtins.int
    TABLE_COMPRESSION_LEVEL_FIELD_NUMBER: _builtins.int
    EXPAND_ALLDIFF_CONSTRAINTS_FIELD_NUMBER: _builtins.int
    EXPAND_RESERVOIR_CONSTRAINTS_FIELD_NUMBER: _builtins.int
    EXPAND_RESERVOIR_USING_CIRCUIT_FIELD_NUMBER: _builtins.int
    ENCODE_CUMULATIVE_AS_RESERVOIR_FIELD_NUMBER: _builtins.int
    MAX_LIN_MAX_SIZE_FOR_EXPANSION_FIELD_NUMBER: _builtins.int
    DISABLE_CONSTRAINT_EXPANSION_FIELD_NUMBER: _builtins.int
    ENCODE_COMPLEX_LINEAR_CONSTRAINT_WITH_INTEGER_FIELD_NUMBER: _builtins.int
    MERGE_NO_OVERLAP_WORK_LIMIT_FIELD_NUMBER: _builtins.int
    MERGE_AT_MOST_ONE_WORK_LIMIT_FIELD_NUMBER: _builtins.int
    PRESOLVE_SUBSTITUTION_LEVEL_FIELD_NUMBER: _builtins.int
    PRESOLVE_EXTRACT_INTEGER_ENFORCEMENT_FIELD_NUMBER: _builtins.int
    PRESOLVE_INCLUSION_WORK_LIMIT_FIELD_NUMBER: _builtins.int
    IGNORE_NAMES_FIELD_NUMBER: _builtins.int
    INFER_ALL_DIFFS_FIELD_NUMBER: _builtins.int
    FIND_BIG_LINEAR_OVERLAP_FIELD_NUMBER: _builtins.int
    USE_SAT_INPROCESSING_FIELD_NUMBER: _builtins.int
    INPROCESSING_DTIME_RATIO_FIELD_NUMBER: _builtins.int
    INPROCESSING_PROBING_DTIME_FIELD_NUMBER: _builtins.int
    INPROCESSING_MINIMIZATION_DTIME_FIELD_NUMBER: _builtins.int
    INPROCESSING_MINIMIZATION_USE_CONFLICT_ANALYSIS_FIELD_NUMBER: _builtins.int
    INPROCESSING_MINIMIZATION_USE_ALL_ORDERINGS_FIELD_NUMBER: _builtins.int
    NUM_WORKERS_FIELD_NUMBER: _builtins.int
    NUM_SEARCH_WORKERS_FIELD_NUMBER: _builtins.int
    NUM_FULL_SUBSOLVERS_FIELD_NUMBER: _builtins.int
    SUBSOLVERS_FIELD_NUMBER: _builtins.int
    EXTRA_SUBSOLVERS_FIELD_NUMBER: _builtins.int
    IGNORE_SUBSOLVERS_FIELD_NUMBER: _builtins.int
    FILTER_SUBSOLVERS_FIELD_NUMBER: _builtins.int
    SUBSOLVER_PARAMS_FIELD_NUMBER: _builtins.int
    INTERLEAVE_SEARCH_FIELD_NUMBER: _builtins.int
    INTERLEAVE_BATCH_SIZE_FIELD_NUMBER: _builtins.int
    SHARE_OBJECTIVE_BOUNDS_FIELD_NUMBER: _builtins.int
    SHARE_LEVEL_ZERO_BOUNDS_FIELD_NUMBER: _builtins.int
    SHARE_BINARY_CLAUSES_FIELD_NUMBER: _builtins.int
    SHARE_GLUE_CLAUSES_FIELD_NUMBER: _builtins.int
    MINIMIZE_SHARED_CLAUSES_FIELD_NUMBER: _builtins.int
    DEBUG_POSTSOLVE_WITH_FULL_SOLVER_FIELD_NUMBER: _builtins.int
    DEBUG_MAX_NUM_PRESOLVE_OPERATIONS_FIELD_NUMBER: _builtins.int
    DEBUG_CRASH_ON_BAD_HINT_FIELD_NUMBER: _builtins.int
    DEBUG_CRASH_IF_PRESOLVE_BREAKS_HINT_FIELD_NUMBER: _builtins.int
    USE_OPTIMIZATION_HINTS_FIELD_NUMBER: _builtins.int
    CORE_MINIMIZATION_LEVEL_FIELD_NUMBER: _builtins.int
    FIND_MULTIPLE_CORES_FIELD_NUMBER: _builtins.int
    COVER_OPTIMIZATION_FIELD_NUMBER: _builtins.int
    MAX_SAT_ASSUMPTION_ORDER_FIELD_NUMBER: _builtins.int
    MAX_SAT_REVERSE_ASSUMPTION_ORDER_FIELD_NUMBER: _builtins.int
    MAX_SAT_STRATIFICATION_FIELD_NUMBER: _builtins.int
    PROPAGATION_LOOP_DETECTION_FACTOR_FIELD_NUMBER: _builtins.int
    USE_PRECEDENCES_IN_DISJUNCTIVE_CONSTRAINT_FIELD_NUMBER: _builtins.int
    MAX_SIZE_TO_CREATE_PRECEDENCE_LITERALS_IN_DISJUNCTIVE_FIELD_NUMBER: _builtins.int
    USE_STRONG_PROPAGATION_IN_DISJUNCTIVE_FIELD_NUMBER: _builtins.int
    USE_DYNAMIC_PRECEDENCE_IN_DISJUNCTIVE_FIELD_NUMBER: _builtins.int
    USE_DYNAMIC_PRECEDENCE_IN_CUMULATIVE_FIELD_NUMBER: _builtins.int
    USE_OVERLOAD_CHECKER_IN_CUMULATIVE_FIELD_NUMBER: _builtins.int
    USE_CONSERVATIVE_SCALE_OVERLOAD_CHECKER_FIELD_NUMBER: _builtins.int
    USE_TIMETABLE_EDGE_FINDING_IN_CUMULATIVE_FIELD_NUMBER: _builtins.int
    MAX_NUM_INTERVALS_FOR_TIMETABLE_EDGE_FINDING_FIELD_NUMBER: _builtins.int
    USE_HARD_PRECEDENCES_IN_CUMULATIVE_FIELD_NUMBER: _builtins.int
    EXPLOIT_ALL_PRECEDENCES_FIELD_NUMBER: _builtins.int
    USE_DISJUNCTIVE_CONSTRAINT_IN_CUMULATIVE_FIELD_NUMBER: _builtins.int
    USE_TIMETABLING_IN_NO_OVERLAP_2D_FIELD_NUMBER: _builtins.int
    USE_ENERGETIC_REASONING_IN_NO_OVERLAP_2D_FIELD_NUMBER: _builtins.int
    USE_AREA_ENERGETIC_REASONING_IN_NO_OVERLAP_2D_FIELD_NUMBER: _builtins.int
    USE_TRY_EDGE_REASONING_IN_NO_OVERLAP_2D_FIELD_NUMBER: _builtins.int
    MAX_PAIRS_PAIRWISE_REASONING_IN_NO_OVERLAP_2D_FIELD_NUMBER: _builtins.int
    MAXIMUM_REGIONS_TO_SPLIT_IN_DISCONNECTED_NO_OVERLAP_2D_FIELD_NUMBER: _builtins.int
    USE_DUAL_SCHEDULING_HEURISTICS_FIELD_NUMBER: _builtins.int
    USE_ALL_DIFFERENT_FOR_CIRCUIT_FIELD_NUMBER: _builtins.int
    ROUTING_CUT_SUBSET_SIZE_FOR_BINARY_RELATION_BOUND_FIELD_NUMBER: _builtins.int
    ROUTING_CUT_SUBSET_SIZE_FOR_TIGHT_BINARY_RELATION_BOUND_FIELD_NUMBER: _builtins.int
    ROUTING_CUT_DP_EFFORT_FIELD_NUMBER: _builtins.int
    SEARCH_BRANCHING_FIELD_NUMBER: _builtins.int
    HINT_CONFLICT_LIMIT_FIELD_NUMBER: _builtins.int
    REPAIR_HINT_FIELD_NUMBER: _builtins.int
    FIX_VARIABLES_TO_THEIR_HINTED_VALUE_FIELD_NUMBER: _builtins.int
    USE_PROBING_SEARCH_FIELD_NUMBER: _builtins.int
    USE_EXTENDED_PROBING_FIELD_NUMBER: _builtins.int
    PROBING_NUM_COMBINATIONS_LIMIT_FIELD_NUMBER: _builtins.int
    USE_SHAVING_IN_PROBING_SEARCH_FIELD_NUMBER: _builtins.int
    SHAVING_SEARCH_DETERMINISTIC_TIME_FIELD_NUMBER: _builtins.int
    SHAVING_SEARCH_THRESHOLD_FIELD_NUMBER: _builtins.int
    USE_OBJECTIVE_LB_SEARCH_FIELD_NUMBER: _builtins.int
    USE_OBJECTIVE_SHAVING_SEARCH_FIELD_NUMBER: _builtins.int
    USE_VARIABLES_SHAVING_SEARCH_FIELD_NUMBER: _builtins.int
    PSEUDO_COST_RELIABILITY_THRESHOLD_FIELD_NUMBER: _builtins.int
    OPTIMIZE_WITH_CORE_FIELD_NUMBER: _builtins.int
    OPTIMIZE_WITH_LB_TREE_SEARCH_FIELD_NUMBER: _builtins.int
    SAVE_LP_BASIS_IN_LB_TREE_SEARCH_FIELD_NUMBER: _builtins.int
    BINARY_SEARCH_NUM_CONFLICTS_FIELD_NUMBER: _builtins.int
    OPTIMIZE_WITH_MAX_HS_FIELD_NUMBER: _builtins.int
    USE_FEASIBILITY_JUMP_FIELD_NUMBER: _builtins.int
    USE_LS_ONLY_FIELD_NUMBER: _builtins.int
    FEASIBILITY_JUMP_DECAY_FIELD_NUMBER: _builtins.int
    FEASIBILITY_JUMP_LINEARIZATION_LEVEL_FIELD_NUMBER: _builtins.int
    FEASIBILITY_JUMP_RESTART_FACTOR_FIELD_NUMBER: _builtins.int
    FEASIBILITY_JUMP_BATCH_DTIME_FIELD_NUMBER: _builtins.int
    FEASIBILITY_JUMP_VAR_RANDOMIZATION_PROBABILITY_FIELD_NUMBER: _builtins.int
    FEASIBILITY_JUMP_VAR_PERBURBATION_RANGE_RATIO_FIELD_NUMBER: _builtins.int
    FEASIBILITY_JUMP_ENABLE_RESTARTS_FIELD_NUMBER: _builtins.int
    FEASIBILITY_JUMP_MAX_EXPANDED_CONSTRAINT_SIZE_FIELD_NUMBER: _builtins.int
    NUM_VIOLATION_LS_FIELD_NUMBER: _builtins.int
    VIOLATION_LS_PERTURBATION_PERIOD_FIELD_NUMBER: _builtins.int
    VIOLATION_LS_COMPOUND_MOVE_PROBABILITY_FIELD_NUMBER: _builtins.int
    SHARED_TREE_NUM_WORKERS_FIELD_NUMBER: _builtins.int
    USE_SHARED_TREE_SEARCH_FIELD_NUMBER: _builtins.int
    SHARED_TREE_WORKER_MIN_RESTARTS_PER_SUBTREE_FIELD_NUMBER: _builtins.int
    SHARED_TREE_WORKER_ENABLE_TRAIL_SHARING_FIELD_NUMBER: _builtins.int
    SHARED_TREE_WORKER_ENABLE_PHASE_SHARING_FIELD_NUMBER: _builtins.int
    SHARED_TREE_OPEN_LEAVES_PER_WORKER_FIELD_NUMBER: _builtins.int
    SHARED_TREE_MAX_NODES_PER_WORKER_FIELD_NUMBER: _builtins.int
    SHARED_TREE_SPLIT_STRATEGY_FIELD_NUMBER: _builtins.int
    SHARED_TREE_BALANCE_TOLERANCE_FIELD_NUMBER: _builtins.int
    ENUMERATE_ALL_SOLUTIONS_FIELD_NUMBER: _builtins.int
    KEEP_ALL_FEASIBLE_SOLUTIONS_IN_PRESOLVE_FIELD_NUMBER: _builtins.int
    FILL_TIGHTENED_DOMAINS_IN_RESPONSE_FIELD_NUMBER: _builtins.int
    FILL_ADDITIONAL_SOLUTIONS_IN_RESPONSE_FIELD_NUMBER: _builtins.int
    INSTANTIATE_ALL_VARIABLES_FIELD_NUMBER: _builtins.int
    AUTO_DETECT_GREATER_THAN_AT_LEAST_ONE_OF_FIELD_NUMBER: _builtins.int
    STOP_AFTER_FIRST_SOLUTION_FIELD_NUMBER: _builtins.int
    STOP_AFTER_PRESOLVE_FIELD_NUMBER: _builtins.int
    STOP_AFTER_ROOT_PROPAGATION_FIELD_NUMBER: _builtins.int
    LNS_INITIAL_DIFFICULTY_FIELD_NUMBER: _builtins.int
    LNS_INITIAL_DETERMINISTIC_LIMIT_FIELD_NUMBER: _builtins.int
    USE_LNS_FIELD_NUMBER: _builtins.int
    USE_LNS_ONLY_FIELD_NUMBER: _builtins.int
    SOLUTION_POOL_SIZE_FIELD_NUMBER: _builtins.int
    USE_RINS_LNS_FIELD_NUMBER: _builtins.int
    USE_FEASIBILITY_PUMP_FIELD_NUMBER: _builtins.int
    USE_LB_RELAX_LNS_FIELD_NUMBER: _builtins.int
    LB_RELAX_NUM_WORKERS_THRESHOLD_FIELD_NUMBER: _builtins.int
    FP_ROUNDING_FIELD_NUMBER: _builtins.int
    DIVERSIFY_LNS_PARAMS_FIELD_NUMBER: _builtins.int
    RANDOMIZE_SEARCH_FIELD_NUMBER: _builtins.int
    SEARCH_RANDOM_VARIABLE_POOL_SIZE_FIELD_NUMBER: _builtins.int
    PUSH_ALL_TASKS_TOWARD_START_FIELD_NUMBER: _builtins.int
    USE_OPTIONAL_VARIABLES_FIELD_NUMBER: _builtins.int
    USE_EXACT_LP_REASON_FIELD_NUMBER: _builtins.int
    USE_COMBINED_NO_OVERLAP_FIELD_NUMBER: _builtins.int
    AT_MOST_ONE_MAX_EXPANSION_SIZE_FIELD_NUMBER: _builtins.int
    CATCH_SIGINT_SIGNAL_FIELD_NUMBER: _builtins.int
    USE_IMPLIED_BOUNDS_FIELD_NUMBER: _builtins.int
    POLISH_LP_SOLUTION_FIELD_NUMBER: _builtins.int
    LP_PRIMAL_TOLERANCE_FIELD_NUMBER: _builtins.int
    LP_DUAL_TOLERANCE_FIELD_NUMBER: _builtins.int
    CONVERT_INTERVALS_FIELD_NUMBER: _builtins.int
    SYMMETRY_LEVEL_FIELD_NUMBER: _builtins.int
    USE_SYMMETRY_IN_LP_FIELD_NUMBER: _builtins.int
    KEEP_SYMMETRY_IN_PRESOLVE_FIELD_NUMBER: _builtins.int
    SYMMETRY_DETECTION_DETERMINISTIC_TIME_LIMIT_FIELD_NUMBER: _builtins.int
    NEW_LINEAR_PROPAGATION_FIELD_NUMBER: _builtins.int
    LINEAR_SPLIT_SIZE_FIELD_NUMBER: _builtins.int
    LINEARIZATION_LEVEL_FIELD_NUMBER: _builtins.int
    BOOLEAN_ENCODING_LEVEL_FIELD_NUMBER: _builtins.int
    MAX_DOMAIN_SIZE_WHEN_ENCODING_EQ_NEQ_CONSTRAINTS_FIELD_NUMBER: _builtins.int
    MAX_NUM_CUTS_FIELD_NUMBER: _builtins.int
    CUT_LEVEL_FIELD_NUMBER: _builtins.int
    ONLY_ADD_CUTS_AT_LEVEL_ZERO_FIELD_NUMBER: _builtins.int
    ADD_OBJECTIVE_CUT_FIELD_NUMBER: _builtins.int
    ADD_CG_CUTS_FIELD_NUMBER: _builtins.int
    ADD_MIR_CUTS_FIELD_NUMBER: _builtins.int
    ADD_ZERO_HALF_CUTS_FIELD_NUMBER: _builtins.int
    ADD_CLIQUE_CUTS_FIELD_NUMBER: _builtins.int
    ADD_RLT_CUTS_FIELD_NUMBER: _builtins.int
    MAX_ALL_DIFF_CUT_SIZE_FIELD_NUMBER: _builtins.int
    ADD_LIN_MAX_CUTS_FIELD_NUMBER: _builtins.int
    MAX_INTEGER_ROUNDING_SCALING_FIELD_NUMBER: _builtins.int
    ADD_LP_CONSTRAINTS_LAZILY_FIELD_NUMBER: _builtins.int
    ROOT_LP_ITERATIONS_FIELD_NUMBER: _builtins.int
    MIN_ORTHOGONALITY_FOR_LP_CONSTRAINTS_FIELD_NUMBER: _builtins.int
    MAX_CUT_ROUNDS_AT_LEVEL_ZERO_FIELD_NUMBER: _builtins.int
    MAX_CONSECUTIVE_INACTIVE_COUNT_FIELD_NUMBER: _builtins.int
    CUT_MAX_ACTIVE_COUNT_VALUE_FIELD_NUMBER: _builtins.int
    CUT_ACTIVE_COUNT_DECAY_FIELD_NUMBER: _builtins.int
    CUT_CLEANUP_TARGET_FIELD_NUMBER: _builtins.int
    NEW_CONSTRAINTS_BATCH_SIZE_FIELD_NUMBER: _builtins.int
    EXPLOIT_INTEGER_LP_SOLUTION_FIELD_NUMBER: _builtins.int
    EXPLOIT_ALL_LP_SOLUTION_FIELD_NUMBER: _builtins.int
    EXPLOIT_BEST_SOLUTION_FIELD_NUMBER: _builtins.int
    EXPLOIT_RELAXATION_SOLUTION_FIELD_NUMBER: _builtins.int
    EXPLOIT_OBJECTIVE_FIELD_NUMBER: _builtins.int
    DETECT_LINEARIZED_PRODUCT_FIELD_NUMBER: _builtins.int
    MIP_MAX_BOUND_FIELD_NUMBER: _builtins.int
    MIP_VAR_SCALING_FIELD_NUMBER: _builtins.int
    MIP_SCALE_LARGE_DOMAIN_FIELD_NUMBER: _builtins.int
    MIP_AUTOMATICALLY_SCALE_VARIABLES_FIELD_NUMBER: _builtins.int
    ONLY_SOLVE_IP_FIELD_NUMBER: _builtins.int
    MIP_WANTED_PRECISION_FIELD_NUMBER: _builtins.int
    MIP_MAX_ACTIVITY_EXPONENT_FIELD_NUMBER: _builtins.int
    MIP_CHECK_PRECISION_FIELD_NUMBER: _builtins.int
    MIP_COMPUTE_TRUE_OBJECTIVE_BOUND_FIELD_NUMBER: _builtins.int
    MIP_MAX_VALID_MAGNITUDE_FIELD_NUMBER: _builtins.int
    MIP_TREAT_HIGH_MAGNITUDE_BOUNDS_AS_INFINITY_FIELD_NUMBER: _builtins.int
    MIP_DROP_TOLERANCE_FIELD_NUMBER: _builtins.int
    MIP_PRESOLVE_LEVEL_FIELD_NUMBER: _builtins.int
    name: _builtins.str
    ...
    use_phase_saving: _builtins.bool
    ...
    """
    polarity_rephase_increment: _builtins.int
    ...
    """
    polarity_exploit_ls_hints: _builtins.bool
    ...
    """
    random_polarity_ratio: _builtins.float
    ...
    """
    random_branches_ratio: _builtins.float
    """A number between 0 and 1 that indicates the proportion of branching
    variables that are selected randomly instead of choosing the first variable
    from the given variable_ordering strategy.
    """
    use_erwa_heuristic: _builtins.bool
    """Whether we use the ERWA (Exponential Recency Weighted Average) heuristic as
    described in "Learning Rate Based Branching Heuristic for SAT solvers",
    J.H.Liang, V. Ganesh, P. Poupart, K.Czarnecki, SAT 2016.
    """
    initial_variables_activity: _builtins.float
    ...
    """
    also_bump_variables_in_conflict_reasons: _builtins.bool
    ...
    subsumption_during_conflict_analysis: _builtins.bool
    """At a really low cost, during the 1-UIP conflict computation, it is easy to
    detect if some of the involved reasons are subsumed by the current
    conflict. When this is true, such clauses are detached and later removed
    from the problem.
    """
    clause_cleanup_period: _builtins.int
    """==========================================================================
    ...
    """
    clause_cleanup_target: _builtins.int
    """During a cleanup, we will always keep that number of "deletable" clauses.
    Note that this doesn't include the "protected" clauses.
    """
    clause_cleanup_ratio: _builtins.float
    ...
    clause_cleanup_lbd_bound: _builtins.int
    """All the clauses with a LBD (literal blocks distance) lower or equal to this
    parameters will always be kept.
    """
    clause_cleanup_ordering: Global___SatParameters.ClauseOrdering.ValueType
    pb_cleanup_increment: _builtins.int
    """Same as for the clauses, but for the learned pseudo-Boolean constraints."""
    pb_cleanup_ratio: _builtins.float
    variable_activity_decay: _builtins.float
    """==========================================================================
    ...
    """
    max_variable_activity_value: _builtins.float
    glucose_max_decay: _builtins.float
    ...
    """
    glucose_decay_increment: _builtins.float
    glucose_decay_increment_period: _builtins.int
    clause_activity_decay: _builtins.float
    """Clause activity parameters (same effect as the one on the variables)."""
    max_clause_activity_value: _builtins.float
    default_restart_algorithms: _builtins.str
    restart_period: _builtins.int
    """Restart period for the FIXED_RESTART strategy. This is also the multiplier
    used by the LUBY_RESTART strategy.
    """
    restart_running_window_size: _builtins.int
    """Size of the window for the moving average restarts."""
    restart_dl_average_ratio: _builtins.float
    """In the moving average restart algorithms, a restart is triggered if the
    window average times this ratio is greater that the global average.
    """
    restart_lbd_average_ratio: _builtins.float
    use_blocking_restart: _builtins.bool
    """Block a moving restart algorithm if the trail size of the current conflict
    is greater than the multiplier times the moving average of the trail size
    at the previous conflicts.
    """
    blocking_restart_window_size: _builtins.int
    blocking_restart_multiplier: _builtins.float
    num_conflicts_before_strategy_changes: _builtins.int
    """After each restart, if the number of conflict since the last strategy
    change is greater that this, then we increment a "strategy_counter" that
    can be use to change the search strategy used by the following restarts.
    """
    strategy_change_increase_ratio: _builtins.float
    ...
    kint64max
    """
    max_memory_in_mb: _builtins.int
    ...
    """
    absolute_gap_limit: _builtins.float
    ...
    """
    relative_gap_limit: _builtins.float
    ...
    """
    permute_variable_randomly: _builtins.bool
    ...
    """
    permute_presolve_constraint_order: _builtins.bool
    use_absl_random: _builtins.bool
    ...
    """
    log_subsolver_statistics: _builtins.bool
    ...
    """Log to stdout."""
    log_to_response: _builtins.bool
    """Log to response proto."""
    use_pb_resolution: _builtins.bool
    """Whether to use pseudo-Boolean resolution to analyze a conflict. Note that
    this option only make sense if your problem is modelized using
    pseudo-Boolean constraints. If you only have clauses, this shouldn't change
    anything (except slow the solver down).
    """
    minimize_reduction_during_pb_resolution: _builtins.bool
    """A different algorithm during PB resolution. It minimizes the number of
    calls to ReduceCoefficients() which can be time consuming. However, the
    search space will be different and if the coefficients are large, this may
    lead to integer overflows that could otherwise be prevented.
    """
    count_assumption_levels_in_lbd: _builtins.bool
    ...
    """
    presolve_bve_threshold: _builtins.int
    """==========================================================================
    Presolve
    ==========================================================================
    ...
    """
    presolve_bve_clause_weight: _builtins.int
    """During presolve, we apply BVE only if this weight times the number of
    clauses plus the number of clause literals is not increased.
    """
    probing_deterministic_time_limit: _builtins.float
    ...
    SAT presolve.
    """
    presolve_probing_deterministic_time_limit: _builtins.float
    presolve_blocked_clause: _builtins.bool
    """Whether we use an heuristic to detect some basic case of blocked clause
    in the SAT presolve.
    """
    presolve_use_bva: _builtins.bool
    """Whether or not we use Bounded Variable Addition (BVA) in the presolve."""
    presolve_bva_threshold: _builtins.int
    """Apply Bounded Variable Addition (BVA) if the number of clauses is reduced
    by stricly more than this threshold. The algorithm described in the paper
    uses 0, but quick experiments showed that 1 is a good value. It may not be
    worth it to add a new variable just to remove one clause.
    """
    max_presolve_iterations: _builtins.int
    """In case of large reduction in a presolve iteration, we perform multiple
    presolve iterations. This parameter controls the maximum number of such
    presolve iterations.
    """
    cp_model_presolve: _builtins.bool
    """Whether we presolve the cp_model before solving it."""
    cp_model_probing_level: _builtins.int
    """How much effort do we spend on probing. 0 disables it completely."""
    cp_model_use_sat_presolve: _builtins.bool
    """Whether we also use the sat presolve when cp_model_presolve is true."""
    remove_fixed_variables_early: _builtins.bool
    ...
    large models.
    """
    detect_table_with_cost: _builtins.bool
    ...
    """
    table_compression_level: _builtins.int
    ...
    """
    expand_reservoir_using_circuit: _builtins.bool
    ...
    constraint).
    """
    encode_cumulative_as_reservoir: _builtins.bool
    ...
    """
    max_lin_max_size_for_expansion: _builtins.int
    ...
    """
    merge_no_overlap_work_limit: _builtins.float
    ...
    """
    merge_at_most_one_work_limit: _builtins.float
    presolve_substitution_level: _builtins.int
    ...
    """
    presolve_extract_integer_enforcement: _builtins.bool
    ...
    created this way).
    """
    presolve_inclusion_work_limit: _builtins.int
    ...
    """
    find_big_linear_overlap: _builtins.bool
    ...
    """
    use_sat_inprocessing: _builtins.bool
    """==========================================================================
    Inprocessing
    ==========================================================================
    ...
    """
    inprocessing_dtime_ratio: _builtins.float
    ...
    """
    inprocessing_probing_dtime: _builtins.float
    """The amount of dtime we should spend on probing for each inprocessing round."""
    inprocessing_minimization_dtime: _builtins.float
    ...
    """
    inprocessing_minimization_use_conflict_analysis: _builtins.bool
    inprocessing_minimization_use_all_orderings: _builtins.bool
    ...
    """
    num_search_workers: _builtins.int
    num_full_subsolvers: _builtins.int
    ...
    you use.
    """
    interleave_search: _builtins.bool
    ...
    """
    interleave_batch_size: _builtins.int
    share_objective_bounds: _builtins.bool
    """Allows objective sharing between workers."""
    share_level_zero_bounds: _builtins.bool
    """Allows sharing of the bounds of modified variables at level 0."""
    share_binary_clauses: _builtins.bool
    """Allows sharing of new learned binary clause between workers."""
    share_glue_clauses: _builtins.bool
    """Allows sharing of short glue clauses between workers.
    Implicitly disabled if share_binary_clauses is false.
    """
    minimize_shared_clauses: _builtins.bool
    """Minimize and detect subsumption of shared clauses immediately after they
    are imported.
    """
    debug_postsolve_with_full_solver: _builtins.bool
    """==========================================================================
    ...
    """
    debug_max_num_presolve_operations: _builtins.int
    ...
    """
    debug_crash_on_bad_hint: _builtins.bool
    """Crash if we do not manage to complete the hint into a full solution."""
    debug_crash_if_presolve_breaks_hint: _builtins.bool
    """Crash if presolve breaks a feasible hint."""
    use_optimization_hints: _builtins.bool
    """==========================================================================
    Max-sat parameters
    ==========================================================================
    ...
    otherwise.
    """
    core_minimization_level: _builtins.int
    ...
    """
    find_multiple_cores: _builtins.bool
    """Whether we try to find more independent cores for a given set of
    assumptions in the core based max-SAT algorithms.
    """
    cover_optimization: _builtins.bool
    ...
    no progress is made.
    """
    use_precedences_in_disjunctive_constraint: _builtins.bool
    ...
    """
    max_size_to_create_precedence_literals_in_disjunctive: _builtins.int
    ...
    true.
    """
    use_strong_propagation_in_disjunctive: _builtins.bool
    """Enable stronger and more expensive propagation on no_overlap constraint."""
    use_dynamic_precedence_in_disjunctive: _builtins.bool
    ...
    """
    use_dynamic_precedence_in_cumulative: _builtins.bool
    use_overload_checker_in_cumulative: _builtins.bool
    ...
    depending on the problem, turning this off may lead to a faster solution.
    """
    use_conservative_scale_overload_checker: _builtins.bool
    ...
    a solution.
    """
    use_timetable_edge_finding_in_cumulative: _builtins.bool
    ...
    """
    exploit_all_precedences: _builtins.bool
    use_disjunctive_constraint_in_cumulative: _builtins.bool
    ...
    depending on the problem, turning this off may lead to a faster solution.
    """
    use_timetabling_in_no_overlap_2d: _builtins.bool
    ...
    """
    use_energetic_reasoning_in_no_overlap_2d: _builtins.bool
    """When this is true, the no_overlap_2d constraint is reinforced with
    energetic reasoning. This additional level supplements the default level of
    reasoning.
    """
    use_area_energetic_reasoning_in_no_overlap_2d: _builtins.bool
    """When this is true, the no_overlap_2d constraint is reinforced with
    an energetic reasoning that uses an area-based energy. This can be combined
    with the two other overlap heuristics above.
    """
    use_try_edge_reasoning_in_no_overlap_2d: _builtins.bool
    max_pairs_pairwise_reasoning_in_no_overlap_2d: _builtins.int
    ...
    intervals.
    """
    maximum_regions_to_split_in_disconnected_no_overlap_2d: _builtins.int
    ...
    """
    use_dual_scheduling_heuristics: _builtins.bool
    ...
    """
    use_all_different_for_circuit: _builtins.bool
    """Turn on extra propagation for the circuit constraint.
    This can be quite slow.
    """
    routing_cut_subset_size_for_binary_relation_bound: _builtins.int
    ...
    """
    routing_cut_subset_size_for_tight_binary_relation_bound: _builtins.int
    ...
    """
    routing_cut_dp_effort: _builtins.float
    ...
    hint_conflict_limit: _builtins.int
    """Conflict limit used in the phase that exploit the solution hint."""
    repair_hint: _builtins.bool
    ...
    """
    fix_variables_to_their_hinted_value: _builtins.bool
    """If true, variables appearing in the solution hints will be fixed to their
    hinted value.
    """
    use_probing_search: _builtins.bool
    ...
    """
    use_objective_lb_search: _builtins.bool
    ...
    """
    use_objective_shaving_search: _builtins.bool
    ...
    """
    save_lp_basis_in_lb_tree_search: _builtins.bool
    ...
    """
    use_feasibility_jump: _builtins.bool
    ...
    """
    feasibility_jump_max_expanded_constraint_size: _builtins.int
    ...
    log n) one.
    """
    num_violation_ls: _builtins.int
    ...
    shared_tree_balance_tolerance: _builtins.int
    ...
    """
    enumerate_all_solutions: _builtins.bool
    ...
    setting keep_all_feasible_solutions_in_presolve ?
    """
    keep_all_feasible_solutions_in_presolve: _builtins.bool
    ...
    search space.
    """
    fill_tightened_domains_in_response: _builtins.bool
    ...
    """
    fill_additional_solutions_in_response: _builtins.bool
    ...
    solution callbacks.
    """
    instantiate_all_variables: _builtins.bool
    ...
    """
    auto_detect_greater_than_at_least_one_of: _builtins.bool
    """If true, then the precedences propagator try to detect for each variable if
    it has a set of "optional incoming arc" for which at least one of them is
    present. This is usually useful to have but can be slow on model with a lot
    of precedence.
    """
    stop_after_first_solution: _builtins.bool
    """For an optimization problem, stop the solver as soon as we have a solution."""
    stop_after_presolve: _builtins.bool
    ...
    """
    stop_after_root_propagation: _builtins.bool
    lns_initial_difficulty: _builtins.float
    """LNS parameters.

    Initial parameters for neighborhood generation.
    """
    lns_initial_deterministic_limit: _builtins.float
    use_lns: _builtins.bool
    """Testing parameters used to disable all lns workers."""
    use_lns_only: _builtins.bool
    """Experimental parameters to disable everything but lns."""
    solution_pool_size: _builtins.int
    ...
    """
    use_rins_lns: _builtins.bool
    """Turns on relaxation induced neighborhood generator."""
    use_feasibility_pump: _builtins.bool
    """Adds a feasibility pump subsolver along with lns subsolvers."""
    use_lb_relax_lns: _builtins.bool
    ...
    Programs", 2023.
    """
    lb_relax_num_workers_threshold: _builtins.int
    """Only use lb-relax if we have at least that many workers."""
    fp_rounding: Global___SatParameters.FPRoundingMethod.ValueType
    diversify_lns_params: _builtins.bool
    """If true, registers more lns subsolvers with different parameters."""
    randomize_search: _builtins.bool
    """Randomize fixed search."""
    search_random_variable_pool_size: _builtins.int
    ...
    """
    push_all_tasks_toward_start: _builtins.bool
    """Experimental code: specify if the objective pushes all tasks toward the
    start of the schedule.
    """
    use_optional_variables: _builtins.bool
    ...
    """
    use_exact_lp_reason: _builtins.bool
    ...
    """
    use_combined_no_overlap: _builtins.bool
    ...
    """
    use_implied_bounds: _builtins.bool
    ...
    stronger cuts.
    """
    polish_lp_solution: _builtins.bool
    ...
    """
    lp_primal_tolerance: _builtins.float
    ...
    solves.
    """
    lp_dual_tolerance: _builtins.float
    convert_intervals: _builtins.bool
    ...
    """
    use_symmetry_in_lp: _builtins.bool
    ...
    """
    keep_symmetry_in_presolve: _builtins.bool
    ...
    """
    symmetry_detection_deterministic_time_limit: _builtins.float
    """Deterministic time limit for symmetry detection."""
    new_linear_propagation: _builtins.bool
    ...
    """
    linear_split_size: _builtins.int
    ...
    """
    linearization_level: _builtins.int
    """==========================================================================
    ...
    """
    boolean_encoding_level: _builtins.int
    """A non-negative level indicating how much we should try to fully encode
    Integer variables as Boolean.
    """
    max_domain_size_when_encoding_eq_neq_constraints: _builtins.int
    ...
    level >= 2.
    """
    only_add_cuts_at_level_zero: _builtins.bool
    """For the cut that can be generated at any level, this control if we only
    try to generate them at the root node.
    """
    add_objective_cut: _builtins.bool
    ...
    help.
    """
    add_cg_cuts: _builtins.bool
    """Whether we generate and add Chvatal-Gomory cuts to the LP at root node.
    Note that for now, this is not heavily tuned.
    """
    add_mir_cuts: _builtins.bool
    """Whether we generate MIR cuts at root node.
    Note that for now, this is not heavily tuned.
    """
    add_zero_half_cuts: _builtins.bool
    """Whether we generate Zero-Half cuts at root node.
    Note that for now, this is not heavily tuned.
    """
    add_clique_cuts: _builtins.bool
    ...
    """
    add_lin_max_cuts: _builtins.bool
    ...
    """
    max_integer_rounding_scaling: _builtins.int
    ...
    and Lodi.
    """
    add_lp_constraints_lazily: _builtins.bool
    """If true, we start by an empty LP, and only add constraints not satisfied
    by the current LP solution batch by batch. A constraint that is only added
    like this is known as a "lazy" constraint in the literature, except that we
    currently consider all constraints as lazy here.
    """
    root_lp_iterations: _builtins.int
    ...
    root node.
    """
    min_orthogonality_for_lp_constraints: _builtins.float
    ...
    feature.
    """
    max_cut_rounds_at_level_zero: _builtins.int
    """Max number of time we perform cut generation and resolve the LP at level 0."""
    max_consecutive_inactive_count: _builtins.int
    ...
    """
    cut_max_active_count_value: _builtins.float
    ...
    """
    cut_active_count_decay: _builtins.float
    cut_cleanup_target: _builtins.int
    """Target number of constraints to remove during cleanup."""
    new_constraints_batch_size: _builtins.int
    """Add that many lazy constraints (or cuts) at once in the LP. Note that at
    the beginning of the solve, we do add more than this.
    """
    exploit_integer_lp_solution: _builtins.bool
    ...
    of the full problem.
    """
    exploit_all_lp_solution: _builtins.bool
    """If true and the Lp relaxation of the problem has a solution, try to exploit
    it. This is same as above except in this case the lp solution might not be
    an integer solution.
    """
    exploit_best_solution: _builtins.bool
    """When branching on a variable, follow the last best solution value."""
    exploit_relaxation_solution: _builtins.bool
    ...
    """
    exploit_objective: _builtins.bool
    """When branching an a variable that directly affect the objective,
    branch on the value that lead to the best objective first.
    """
    detect_linearized_product: _builtins.bool
    ...
    """
    mip_automatically_scale_variables: _builtins.bool
    ...
    """
    mip_wanted_precision: _builtins.float
    ...
    """
    mip_max_activity_exponent: _builtins.int
    ...
    lower than this.
    """
    mip_check_precision: _builtins.float
    ...
    """
    mip_compute_true_objective_bound: _builtins.bool
    ...
    off.
    """
    mip_max_valid_magnitude: _builtins.float
    ...
    MIP.
    """
    mip_treat_high_magnitude_bounds_as_infinity: _builtins.bool
    ...
    """
    mip_drop_tolerance: _builtins.float
    ...
    """
    mip_presolve_level: _builtins.int
    ...
    """
    @_builtins.property
    def restart_algorithms(self) -> _containers.RepeatedScalarFieldContainer[Global___SatParameters.RestartAlgorithm.ValueType]:
    ...
    @_builtins.property
    def subsolvers(self) -> _containers.RepeatedScalarFieldContainer[_builtins.str]:
    ...
    @_builtins.property
    def extra_subsolvers(self) -> _containers.RepeatedScalarFieldContainer[_builtins.str]:
        """A convenient way to add more workers types.
        These will be added at the beginning of the list.
        """

    @_builtins.property
    def ignore_subsolvers(self) -> _containers.RepeatedScalarFieldContainer[_builtins.str]:
    ...
    @_builtins.property
    def filter_subsolvers(self) -> _containers.RepeatedScalarFieldContainer[_builtins.str]: ...
    @_builtins.property
    def subsolver_params(self) -> _containers.RepeatedCompositeFieldContainer[Global___SatParameters]:
    ...
    def __init__(
        ...
        *,
        ...
        use_phase_saving: _builtins.bool | None = ...,
        polarity_rephase_increment: _builtins.int | None = ...,
        polarity_exploit_ls_hints: _builtins.bool | None = ...,
        random_polarity_ratio: _builtins.float | None = ...,
        random_branches_ratio: _builtins.float | None = ...,
        use_erwa_heuristic: _builtins.bool | None = ...,
        initial_variables_activity: _builtins.float | None = ...,
        also_bump_variables_in_conflict_reasons: _builtins.bool | None = ...,
        ...
        subsumption_during_conflict_analysis: _builtins.bool | None = ...,
        clause_cleanup_period: _builtins.int | None = ...,
        clause_cleanup_target: _builtins.int | None = ...,
        clause_cleanup_ratio: _builtins.float | None = ...,
        clause_cleanup_protection: Global___SatParameters.ClauseProtection.ValueType | None = ...,
        clause_cleanup_lbd_bound: _builtins.int | None = ...,
        clause_cleanup_ordering: Global___SatParameters.ClauseOrdering.ValueType | None = ...,
        pb_cleanup_increment: _builtins.int | None = ...,
        pb_cleanup_ratio: _builtins.float | None = ...,
        variable_activity_decay: _builtins.float | None = ...,
        max_variable_activity_value: _builtins.float | None = ...,
        glucose_max_decay: _builtins.float | None = ...,
        glucose_decay_increment: _builtins.float | None = ...,
        glucose_decay_increment_period: _builtins.int | None = ...,
        clause_activity_decay: _builtins.float | None = ...,
        max_clause_activity_value: _builtins.float | None = ...,
        restart_algorithms: _abc.Iterable[Global___SatParameters.RestartAlgorithm.ValueType] | None = ...,
        default_restart_algorithms: _builtins.str | None = ...,
        restart_period: _builtins.int | None = ...,
        restart_running_window_size: _builtins.int | None = ...,
        restart_dl_average_ratio: _builtins.float | None = ...,
        restart_lbd_average_ratio: _builtins.float | None = ...,
        use_blocking_restart: _builtins.bool | None = ...,
        blocking_restart_window_size: _builtins.int | None = ...,
        blocking_restart_multiplier: _builtins.float | None = ...,
        num_conflicts_before_strategy_changes: _builtins.int | None = ...,
        strategy_change_increase_ratio: _builtins.float | None = ...,
        max_time_in_seconds: _builtins.float | None = ...,
        max_deterministic_time: _builtins.float | None = ...,
        max_num_deterministic_batches: _builtins.int | None = ...,
        max_number_of_conflicts: _builtins.int | None = ...,
        max_memory_in_mb: _builtins.int | None = ...,
        absolute_gap_limit: _builtins.float | None = ...,
        relative_gap_limit: _builtins.float | None = ...,
        random_seed: _builtins.int | None = ...,
        permute_variable_randomly: _builtins.bool | None = ...,
        permute_presolve_constraint_order: _builtins.bool | None = ...,
        use_absl_random: _builtins.bool | None = ...,
        log_search_progress: _builtins.bool | None = ...,
        log_subsolver_statistics: _builtins.bool | None = ...,
        log_prefix: _builtins.str | None = ...,
        log_to_stdout: _builtins.bool | None = ...,
        log_to_response: _builtins.bool | None = ...,
        use_pb_resolution: _builtins.bool | None = ...,
        minimize_reduction_during_pb_resolution: _builtins.bool | None = ...,
        count_assumption_levels_in_lbd: _builtins.bool | None = ...,
        presolve_bve_threshold: _builtins.int | None = ...,
        presolve_bve_clause_weight: _builtins.int | None = ...,
        probing_deterministic_time_limit: _builtins.float | None = ...,
        presolve_probing_deterministic_time_limit: _builtins.float | None = ...,
        presolve_blocked_clause: _builtins.bool | None = ...,
        presolve_use_bva: _builtins.bool | None = ...,
        presolve_bva_threshold: _builtins.int | None = ...,
        max_presolve_iterations: _builtins.int | None = ...,
        cp_model_presolve: _builtins.bool | None = ...,
        cp_model_probing_level: _builtins.int | None = ...,
        cp_model_use_sat_presolve: _builtins.bool | None = ...,
        remove_fixed_variables_early: _builtins.bool | None = ...,
        detect_table_with_cost: _builtins.bool | None = ...,
        table_compression_level: _builtins.int | None = ...,
        expand_alldiff_constraints: _builtins.bool | None = ...,
        expand_reservoir_constraints: _builtins.bool | None = ...,
        expand_reservoir_using_circuit: _builtins.bool | None = ...,
        encode_cumulative_as_reservoir: _builtins.bool | None = ...,
        max_lin_max_size_for_expansion: _builtins.int | None = ...,
        disable_constraint_expansion: _builtins.bool | None = ...,
        encode_complex_linear_constraint_with_integer: _builtins.bool | None = ...,
        merge_no_overlap_work_limit: _builtins.float | None = ...,
        merge_at_most_one_work_limit: _builtins.float | None = ...,
        presolve_substitution_level: _builtins.int | None = ...,
        presolve_extract_integer_enforcement: _builtins.bool | None = ...,
        presolve_inclusion_work_limit: _builtins.int | None = ...,
        ignore_names: _builtins.bool | None = ...,
        infer_all_diffs: _builtins.bool | None = ...,
        find_big_linear_overlap: _builtins.bool | None = ...,
        use_sat_inprocessing: _builtins.bool | None = ...,
        inprocessing_dtime_ratio: _builtins.float | None = ...,
        inprocessing_probing_dtime: _builtins.float | None = ...,
        inprocessing_minimization_dtime: _builtins.float | None = ...,
        inprocessing_minimization_use_conflict_analysis: _builtins.bool | None = ...,
        inprocessing_minimization_use_all_orderings: _builtins.bool | None = ...,
        num_workers: _builtins.int | None = ...,
        num_search_workers: _builtins.int | None = ...,
        num_full_subsolvers: _builtins.int | None = ...,
        subsolvers: _abc.Iterable[_builtins.str] | None = ...,
        extra_subsolvers: _abc.Iterable[_builtins.str] | None = ...,
        ignore_subsolvers: _abc.Iterable[_builtins.str] | None = ...,
        filter_subsolvers: _abc.Iterable[_builtins.str] | None = ...,
        subsolver_params: _abc.Iterable[Global___SatParameters] | None = ...,
        interleave_search: _builtins.bool | None = ...,
        interleave_batch_size: _builtins.int | None = ...,
        share_objective_bounds: _builtins.bool | None = ...,
        share_level_zero_bounds: _builtins.bool | None = ...,
        share_binary_clauses: _builtins.bool | None = ...,
        share_glue_clauses: _builtins.bool | None = ...,
        minimize_shared_clauses: _builtins.bool | None = ...,
        debug_postsolve_with_full_solver: _builtins.bool | None = ...,
        debug_max_num_presolve_operations: _builtins.int | None = ...,
        debug_crash_on_bad_hint: _builtins.bool | None = ...,
        debug_crash_if_presolve_breaks_hint: _builtins.bool | None = ...,
        use_optimization_hints: _builtins.bool | None = ...,
        core_minimization_level: _builtins.int | None = ...,
        find_multiple_cores: _builtins.bool | None = ...,
        cover_optimization: _builtins.bool | None = ...,
        max_sat_assumption_order: Global___SatParameters.MaxSatAssumptionOrder.ValueType | None = ...,
        max_sat_reverse_assumption_order: _builtins.bool | None = ...,
        max_sat_stratification: Global___SatParameters.MaxSatStratificationAlgorithm.ValueType | None = ...,
        propagation_loop_detection_factor: _builtins.float | None = ...,
        use_precedences_in_disjunctive_constraint: _builtins.bool | None = ...,
        max_size_to_create_precedence_literals_in_disjunctive: _builtins.int | None = ...,
        use_strong_propagation_in_disjunctive: _builtins.bool | None = ...,
        use_dynamic_precedence_in_disjunctive: _builtins.bool | None = ...,
        use_dynamic_precedence_in_cumulative: _builtins.bool | None = ...,
        use_overload_checker_in_cumulative: _builtins.bool | None = ...,
        use_conservative_scale_overload_checker: _builtins.bool | None = ...,
        use_timetable_edge_finding_in_cumulative: _builtins.bool | None = ...,
        max_num_intervals_for_timetable_edge_finding: _builtins.int | None = ...,
        use_hard_precedences_in_cumulative: _builtins.bool | None = ...,
        exploit_all_precedences: _builtins.bool | None = ...,
        use_disjunctive_constraint_in_cumulative: _builtins.bool | None = ...,
        use_timetabling_in_no_overlap_2d: _builtins.bool | None = ...,
        use_energetic_reasoning_in_no_overlap_2d: _builtins.bool | None = ...,
        use_area_energetic_reasoning_in_no_overlap_2d: _builtins.bool | None = ...,
        use_try_edge_reasoning_in_no_overlap_2d: _builtins.bool | None = ...,
        max_pairs_pairwise_reasoning_in_no_overlap_2d: _builtins.int | None = ...,
        maximum_regions_to_split_in_disconnected_no_overlap_2d: _builtins.int | None = ...,
        use_dual_scheduling_heuristics: _builtins.bool | None = ...,
        use_all_different_for_circuit: _builtins.bool | None = ...,
        routing_cut_subset_size_for_binary_relation_bound: _builtins.int | None = ...,
        routing_cut_subset_size_for_tight_binary_relation_bound: _builtins.int | None = ...,
        routing_cut_dp_effort: _builtins.float | None = ...,
        search_branching: Global___SatParameters.SearchBranching.ValueType | None = ...,
        hint_conflict_limit: _builtins.int | None = ...,
        repair_hint: _builtins.bool | None = ...,
        fix_variables_to_their_hinted_value: _builtins.bool | None = ...,
        use_probing_search: _builtins.bool | None = ...,
        use_extended_probing: _builtins.bool | None = ...,
        probing_num_combinations_limit: _builtins.int | None = ...,
        use_shaving_in_probing_search: _builtins.bool | None = ...,
        shaving_search_deterministic_time: _builtins.float | None = ...,
        shaving_search_threshold: _builtins.int | None = ...,
        use_objective_lb_search: _builtins.bool | None = ...,
        use_objective_shaving_search: _builtins.bool | None = ...,
        use_variables_shaving_search: _builtins.bool | None = ...,
        pseudo_cost_reliability_threshold: _builtins.int | None = ...,
        optimize_with_core: _builtins.bool | None = ...,
        optimize_with_lb_tree_search: _builtins.bool | None = ...,
        save_lp_basis_in_lb_tree_search: _builtins.bool | None = ...,
        binary_search_num_conflicts: _builtins.int | None = ...,
        optimize_with_max_hs: _builtins.bool | None = ...,
        use_feasibility_jump: _builtins.bool | None = ...,
        use_ls_only: _builtins.bool | None = ...,
        feasibility_jump_decay: _builtins.float | None = ...,
        feasibility_jump_linearization_level: _builtins.int | None = ...,
        feasibility_jump_restart_factor: _builtins.int | None = ...,
        feasibility_jump_batch_dtime: _builtins.float | None = ...,
        feasibility_jump_var_randomization_probability: _builtins.float | None = ...,
        feasibility_jump_var_perburbation_range_ratio: _builtins.float | None = ...,
        feasibility_jump_enable_restarts: _builtins.bool | None = ...,
        feasibility_jump_max_expanded_constraint_size: _builtins.int | None = ...,
        num_violation_ls: _builtins.int | None = ...,
        violation_ls_perturbation_period: _builtins.int | None = ...,
        violation_ls_compound_move_probability: _builtins.float | None = ...,
        shared_tree_num_workers: _builtins.int | None = ...,
        use_shared_tree_search: _builtins.bool | None = ...,
        shared_tree_worker_min_restarts_per_subtree: _builtins.int | None = ...,
        shared_tree_worker_enable_trail_sharing: _builtins.bool | None = ...,
        shared_tree_worker_enable_phase_sharing: _builtins.bool | None = ...,
        shared_tree_open_leaves_per_worker: _builtins.float | None = ...,
        shared_tree_max_nodes_per_worker: _builtins.int | None = ...,
        shared_tree_split_strategy: Global___SatParameters.SharedTreeSplitStrategy.ValueType | None = ...,
        shared_tree_balance_tolerance: _builtins.int | None = ...,
        enumerate_all_solutions: _builtins.bool | None = ...,
        keep_all_feasible_solutions_in_presolve: _builtins.bool | None = ...,
        fill_tightened_domains_in_response: _builtins.bool | None = ...,
        fill_additional_solutions_in_response: _builtins.bool | None = ...,
        instantiate_all_variables: _builtins.bool | None = ...,
        auto_detect_greater_than_at_least_one_of: _builtins.bool | None = ...,
        stop_after_first_solution: _builtins.bool | None = ...,
        stop_after_presolve: _builtins.bool | None = ...,
        stop_after_root_propagation: _builtins.bool | None = ...,
        lns_initial_difficulty: _builtins.float | None = ...,
        lns_initial_deterministic_limit: _builtins.float | None = ...,
        use_lns: _builtins.bool | None = ...,
        use_lns_only: _builtins.bool | None = ...,
        solution_pool_size: _builtins.int | None = ...,
        use_rins_lns: _builtins.bool | None = ...,
        use_feasibility_pump: _builtins.bool | None = ...,
        use_lb_relax_lns: _builtins.bool | None = ...,
        lb_relax_num_workers_threshold: _builtins.int | None = ...,
        fp_rounding: Global___SatParameters.FPRoundingMethod.ValueType | None = ...,
        diversify_lns_params: _builtins.bool | None = ...,
        randomize_search: _builtins.bool | None = ...,
        search_random_variable_pool_size: _builtins.int | None = ...,
        push_all_tasks_toward_start: _builtins.bool | None = ...,
        use_optional_variables: _builtins.bool | None = ...,
        use_exact_lp_reason: _builtins.bool | None = ...,
        use_combined_no_overlap: _builtins.bool | None = ...,
        at_most_one_max_expansion_size: _builtins.int | None = ...,
        catch_sigint_signal: _builtins.bool | None = ...,
        use_implied_bounds: _builtins.bool | None = ...,
        polish_lp_solution: _builtins.bool | None = ...,
        lp_primal_tolerance: _builtins.float | None = ...,
        lp_dual_tolerance: _builtins.float | None = ...,
        convert_intervals: _builtins.bool | None = ...,
        symmetry_level: _builtins.int | None = ...,
        use_symmetry_in_lp: _builtins.bool | None = ...,
        keep_symmetry_in_presolve: _builtins.bool | None = ...,
        symmetry_detection_deterministic_time_limit: _builtins.float | None = ...,
        new_linear_propagation: _builtins.bool | None = ...,
        linear_split_size: _builtins.int | None = ...,
        linearization_level: _builtins.int | None = ...,
        boolean_encoding_level: _builtins.int | None = ...,
        max_domain_size_when_encoding_eq_neq_constraints: _builtins.int | None = ...,
        max_num_cuts: _builtins.int | None = ...,
        cut_level: _builtins.int | None = ...,
        only_add_cuts_at_level_zero: _builtins.bool | None = ...,
        add_objective_cut: _builtins.bool | None = ...,
        add_cg_cuts: _builtins.bool | None = ...,
        add_mir_cuts: _builtins.bool | None = ...,
        add_zero_half_cuts: _builtins.bool | None = ...,
        add_clique_cuts: _builtins.bool | None = ...,
        add_rlt_cuts: _builtins.bool | None = ...,
        max_all_diff_cut_size: _builtins.int | None = ...,
        add_lin_max_cuts: _builtins.bool | None = ...,
        max_integer_rounding_scaling: _builtins.int | None = ...,
        add_lp_constraints_lazily: _builtins.bool | None = ...,
        root_lp_iterations: _builtins.int | None = ...,
        min_orthogonality_for_lp_constraints: _builtins.float | None = ...,
        max_cut_rounds_at_level_zero: _builtins.int | None = ...,
        max_consecutive_inactive_count: _builtins.int | None = ...,
        cut_max_active_count_value: _builtins.float | None = ...,
        cut_active_count_decay: _builtins.float | None = ...,
        cut_cleanup_target: _builtins.int | None = ...,
        new_constraints_batch_size: _builtins.int | None = ...,
        exploit_integer_lp_solution: _builtins.bool | None = ...,
        exploit_all_lp_solution: _builtins.bool | None = ...,
        exploit_best_solution: _builtins.bool | None = ...,
        exploit_relaxation_solution: _builtins.bool | None = ...,
        exploit_objective: _builtins.bool | None = ...,
        detect_linearized_product: _builtins.bool | None = ...,
        mip_max_bound: _builtins.float | None = ...,
        mip_var_scaling: _builtins.float | None = ...,
        mip_scale_large_domain: _builtins.bool | None = ...,
        mip_automatically_scale_variables: _builtins.bool | None = ...,
        only_solve_ip: _builtins.bool | None = ...,
        mip_wanted_precision: _builtins.float | None = ...,
        mip_max_activity_exponent: _builtins.int | None = ...,
        mip_check_precision: _builtins.float | None = ...,
        mip_compute_true_objective_bound: _builtins.bool | None = ...,
        mip_max_valid_magnitude: _builtins.float | None = ...,
        mip_treat_high_magnitude_bounds_as_infinity: _builtins.bool | None = ...,
        mip_drop_tolerance: _builtins.float | None = ...,
        mip_presolve_level: _builtins.int | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["absolute_gap_limit", b"absolute_gap_limit", "add_cg_cuts", b"add_cg_cuts", "add_clique_cuts", b"add_clique_cuts", "add_lin_max_cuts", b"add_lin_max_cuts", "add_lp_constraints_lazily", b"add_lp_constraints_lazily", "add_mir_cuts", b"add_mir_cuts", "add_objective_cut", b"add_objective_cut", "add_rlt_cuts", b"add_rlt_cuts", "add_zero_half_cuts", b"add_zero_half_cuts", "also_bump_variables_in_conflict_reasons", b"also_bump_variables_in_conflict_reasons", "at_most_one_max_expansion_size", b"at_most_one_max_expansion_size", "auto_detect_greater_than_at_least_one_of", b"auto_detect_greater_than_at_least_one_of", "binary_minimization_algorithm", b"binary_minimization_algorithm", "binary_search_num_conflicts", b"binary_search_num_conflicts", "blocking_restart_multiplier", b"blocking_restart_multiplier", "blocking_restart_window_size", b"blocking_restart_window_size", "boolean_encoding_level", b"boolean_encoding_level", "catch_sigint_signal", b"catch_sigint_signal", "clause_activity_decay", b"clause_activity_decay", "clause_cleanup_lbd_bound", b"clause_cleanup_lbd_bound", "clause_cleanup_ordering", b"clause_cleanup_ordering", "clause_cleanup_period", b"clause_cleanup_period", "clause_cleanup_protection", b"clause_cleanup_protection", "clause_cleanup_ratio", b"clause_cleanup_ratio", "clause_cleanup_target", b"clause_cleanup_target", "convert_intervals", b"convert_intervals", "core_minimization_level", b"core_minimization_level", "count_assumption_levels_in_lbd", b"count_assumption_levels_in_lbd", "cover_optimization", b"cover_optimization", "cp_model_presolve", b"cp_model_presolve", "cp_model_probing_level", b"cp_model_probing_level", "cp_model_use_sat_presolve", b"cp_model_use_sat_presolve", "cut_active_count_decay", b"cut_active_count_decay", "cut_cleanup_target", b"cut_cleanup_target", "cut_level", b"cut_level", "cut_max_active_count_value", b"cut_max_active_count_value", "debug_crash_if_presolve_breaks_hint", b"debug_crash_if_presolve_breaks_hint", "debug_crash_on_bad_hint", b"debug_crash_on_bad_hint", "debug_max_num_presolve_operations", b"debug_max_num_presolve_operations", "debug_postsolve_with_full_solver", b"debug_postsolve_with_full_solver", "default_restart_algorithms", b"default_restart_algorithms", "detect_linearized_product", b"detect_linearized_product", "detect_table_with_cost", b"detect_table_with_cost", "disable_constraint_expansion", b"disable_constraint_expansion", "diversify_lns_params", b"diversify_lns_params", "encode_complex_linear_constraint_with_integer", b"encode_complex_linear_constraint_with_integer", "encode_cumulative_as_reservoir", b"encode_cumulative_as_reservoir", "enumerate_all_solutions", b"enumerate_all_solutions", "expand_alldiff_constraints", b"expand_alldiff_constraints", "expand_reservoir_constraints", b"expand_reservoir_constraints", "expand_reservoir_using_circuit", b"expand_reservoir_using_circuit", "exploit_all_lp_solution", b"exploit_all_lp_solution", "exploit_all_precedences", b"exploit_all_precedences", "exploit_best_solution", b"exploit_best_solution", "exploit_integer_lp_solution", b"exploit_integer_lp_solution", "exploit_objective", b"exploit_objective", "exploit_relaxation_solution", b"exploit_relaxation_solution", "feasibility_jump_batch_dtime", b"feasibility_jump_batch_dtime", "feasibility_jump_decay", b"feasibility_jump_decay", "feasibility_jump_enable_restarts", b"feasibility_jump_enable_restarts", "feasibility_jump_linearization_level", b"feasibility_jump_linearization_level", "feasibility_jump_max_expanded_constraint_size", b"feasibility_jump_max_expanded_constraint_size", "feasibility_jump_restart_factor", b"feasibility_jump_restart_factor", "feasibility_jump_var_perburbation_range_ratio", b"feasibility_jump_var_perburbation_range_ratio", "feasibility_jump_var_randomization_probability", b"feasibility_jump_var_randomization_probability", "fill_additional_solutions_in_response", b"fill_additional_solutions_in_response", "fill_tightened_domains_in_response", b"fill_tightened_domains_in_response", "find_big_linear_overlap", b"find_big_linear_overlap", "find_multiple_cores", b"find_multiple_cores", "fix_variables_to_their_hinted_value", b"fix_variables_to_their_hinted_value", "fp_rounding", b"fp_rounding", "glucose_decay_increment", b"glucose_decay_increment", "glucose_decay_increment_period", b"glucose_decay_increment_period", "glucose_max_decay", b"glucose_max_decay", "hint_conflict_limit", b"hint_conflict_limit", "ignore_names", b"ignore_names", "infer_all_diffs", b"infer_all_diffs", "initial_polarity", b"initial_polarity", "initial_variables_activity", b"initial_variables_activity", "inprocessing_dtime_ratio", b"inprocessing_dtime_ratio", "inprocessing_minimization_dtime", b"inprocessing_minimization_dtime", "inprocessing_minimization_use_all_orderings", b"inprocessing_minimization_use_all_orderings", "inprocessing_minimization_use_conflict_analysis", b"inprocessing_minimization_use_conflict_analysis", "inprocessing_probing_dtime", b"inprocessing_probing_dtime", "instantiate_all_variables", b"instantiate_all_variables", "interleave_batch_size", b"interleave_batch_size", "interleave_search", b"interleave_search", "keep_all_feasible_solutions_in_presolve", b"keep_all_feasible_solutions_in_presolve", "keep_symmetry_in_presolve", b"keep_symmetry_in_presolve", "lb_relax_num_workers_threshold", b"lb_relax_num_workers_threshold", "linear_split_size", b"linear_split_size", "linearization_level", b"linearization_level", "lns_initial_deterministic_limit", b"lns_initial_deterministic_limit", "lns_initial_difficulty", b"lns_initial_difficulty", "log_prefix", b"log_prefix", "log_search_progress", b"log_search_progress", "log_subsolver_statistics", b"log_subsolver_statistics", "log_to_response", b"log_to_response", "log_to_stdout", b"log_to_stdout", "lp_dual_tolerance", b"lp_dual_tolerance", "lp_primal_tolerance", b"lp_primal_tolerance", "max_all_diff_cut_size", b"max_all_diff_cut_size", "max_clause_activity_value", b"max_clause_activity_value", "max_consecutive_inactive_count", b"max_consecutive_inactive_count", "max_cut_rounds_at_level_zero", b"max_cut_rounds_at_level_zero", "max_deterministic_time", b"max_deterministic_time", "max_domain_size_when_encoding_eq_neq_constraints", b"max_domain_size_when_encoding_eq_neq_constraints", "max_integer_rounding_scaling", b"max_integer_rounding_scaling", "max_lin_max_size_for_expansion", b"max_lin_max_size_for_expansion", "max_memory_in_mb", b"max_memory_in_mb", "max_num_cuts", b"max_num_cuts", "max_num_deterministic_batches", b"max_num_deterministic_batches", "max_num_intervals_for_timetable_edge_finding", b"max_num_intervals_for_timetable_edge_finding", "max_number_of_conflicts", b"max_number_of_conflicts", "max_pairs_pairwise_reasoning_in_no_overlap_2d", b"max_pairs_pairwise_reasoning_in_no_overlap_2d", "max_presolve_iterations", b"max_presolve_iterations", "max_sat_assumption_order", b"max_sat_assumption_order", "max_sat_reverse_assumption_order", b"max_sat_reverse_assumption_order", "max_sat_stratification", b"max_sat_stratification", "max_size_to_create_precedence_literals_in_disjunctive", b"max_size_to_create_precedence_literals_in_disjunctive", "max_time_in_seconds", b"max_time_in_seconds", "max_variable_activity_value", b"max_variable_activity_value", "maximum_regions_to_split_in_disconnected_no_overlap_2d", b"maximum_regions_to_split_in_disconnected_no_overlap_2d", "merge_at_most_one_work_limit", b"merge_at_most_one_work_limit", "merge_no_overlap_work_limit", b"merge_no_overlap_work_limit", "min_orthogonality_for_lp_constraints", b"min_orthogonality_for_lp_constraints", "minimization_algorithm", b"minimization_algorithm", "minimize_reduction_during_pb_resolution", b"minimize_reduction_during_pb_resolution", "minimize_shared_clauses", b"minimize_shared_clauses", "mip_automatically_scale_variables", b"mip_automatically_scale_variables", "mip_check_precision", b"mip_check_precision", "mip_compute_true_objective_bound", b"mip_compute_true_objective_bound", "mip_drop_tolerance", b"mip_drop_tolerance", "mip_max_activity_exponent", b"mip_max_activity_exponent", "mip_max_bound", b"mip_max_bound", "mip_max_valid_magnitude", b"mip_max_valid_magnitude", "mip_presolve_level", b"mip_presolve_level", "mip_scale_large_domain", b"mip_scale_large_domain", "mip_treat_high_magnitude_bounds_as_infinity", b"mip_treat_high_magnitude_bounds_as_infinity", "mip_var_scaling", b"mip_var_scaling", "mip_wanted_precision", b"mip_wanted_precision", "name", b"name", "new_constraints_batch_size", b"new_constraints_batch_size", "new_linear_propagation", b"new_linear_propagation", "num_conflicts_before_strategy_changes", b"num_conflicts_before_strategy_changes", "num_full_subsolvers", b"num_full_subsolvers", "num_search_workers", b"num_search_workers", "num_violation_ls", b"num_violation_ls", "num_workers", b"num_workers", "only_add_cuts_at_level_zero", b"only_add_cuts_at_level_zero", "only_solve_ip", b"only_solve_ip", "optimize_with_core", b"optimize_with_core", "optimize_with_lb_tree_search", b"optimize_with_lb_tree_search", "optimize_with_max_hs", b"optimize_with_max_hs", "pb_cleanup_increment", b"pb_cleanup_increment", "pb_cleanup_ratio", b"pb_cleanup_ratio", "permute_presolve_constraint_order", b"permute_presolve_constraint_order", "permute_variable_randomly", b"permute_variable_randomly", "polarity_exploit_ls_hints", b"polarity_exploit_ls_hints", "polarity_rephase_increment", b"polarity_rephase_increment", "polish_lp_solution", b"polish_lp_solution", "preferred_variable_order", b"preferred_variable_order", "presolve_blocked_clause", b"presolve_blocked_clause", "presolve_bva_threshold", b"presolve_bva_threshold", "presolve_bve_clause_weight", b"presolve_bve_clause_weight", "presolve_bve_threshold", b"presolve_bve_threshold", "presolve_extract_integer_enforcement", b"presolve_extract_integer_enforcement", "presolve_inclusion_work_limit", b"presolve_inclusion_work_limit", "presolve_probing_deterministic_time_limit", b"presolve_probing_deterministic_time_limit", "presolve_substitution_level", b"presolve_substitution_level", "presolve_use_bva", b"presolve_use_bva", "probing_deterministic_time_limit", b"probing_deterministic_time_limit", "probing_num_combinations_limit", b"probing_num_combinations_limit", "propagation_loop_detection_factor", b"propagation_loop_detection_factor", "pseudo_cost_reliability_threshold", b"pseudo_cost_reliability_threshold", "push_all_tasks_toward_start", b"push_all_tasks_toward_start", "random_branches_ratio", b"random_branches_ratio", "random_polarity_ratio", b"random_polarity_ratio", "random_seed", b"random_seed", "randomize_search", b"randomize_search", "relative_gap_limit", b"relative_gap_limit", "remove_fixed_variables_early", b"remove_fixed_variables_early", "repair_hint", b"repair_hint", "restart_dl_average_ratio", b"restart_dl_average_ratio", "restart_lbd_average_ratio", b"restart_lbd_average_ratio", "restart_period", b"restart_period", "restart_running_window_size", b"restart_running_window_size", "root_lp_iterations", b"root_lp_iterations", "routing_cut_dp_effort", b"routing_cut_dp_effort", "routing_cut_subset_size_for_binary_relation_bound", b"routing_cut_subset_size_for_binary_relation_bound", "routing_cut_subset_size_for_tight_binary_relation_bound", b"routing_cut_subset_size_for_tight_binary_relation_bound", "save_lp_basis_in_lb_tree_search", b"save_lp_basis_in_lb_tree_search", "search_branching", b"search_branching", "search_random_variable_pool_size", b"search_random_variable_pool_size", "share_binary_clauses", b"share_binary_clauses", "share_glue_clauses", b"share_glue_clauses", "share_level_zero_bounds", b"share_level_zero_bounds", "share_objective_bounds", b"share_objective_bounds", "shared_tree_balance_tolerance", b"shared_tree_balance_tolerance", "shared_tree_max_nodes_per_worker", b"shared_tree_max_nodes_per_worker", "shared_tree_num_workers", b"shared_tree_num_workers", "shared_tree_open_leaves_per_worker", b"shared_tree_open_leaves_per_worker", "shared_tree_split_strategy", b"shared_tree_split_strategy", "shared_tree_worker_enable_phase_sharing", b"shared_tree_worker_enable_phase_sharing", "shared_tree_worker_enable_trail_sharing", b"shared_tree_worker_enable_trail_sharing", "shared_tree_worker_min_restarts_per_subtree", b"shared_tree_worker_min_restarts_per_subtree", "shaving_search_deterministic_time", b"shaving_search_deterministic_time", "shaving_search_threshold", b"shaving_search_threshold", "solution_pool_size", b"solution_pool_size", "stop_after_first_solution", b"stop_after_first_solution", "stop_after_presolve", b"stop_after_presolve", "stop_after_root_propagation", b"stop_after_root_propagation", "strategy_change_increase_ratio", b"strategy_change_increase_ratio", "subsumption_during_conflict_analysis", b"subsumption_during_conflict_analysis", "symmetry_detection_deterministic_time_limit", b"symmetry_detection_deterministic_time_limit", "symmetry_level", b"symmetry_level", "table_compression_level", b"table_compression_level", "use_absl_random", b"use_absl_random", "use_all_different_for_circuit", b"use_all_different_for_circuit", "use_area_energetic_reasoning_in_no_overlap_2d", b"use_area_energetic_reasoning_in_no_overlap_2d", "use_blocking_restart", b"use_blocking_restart", "use_combined_no_overlap", b"use_combined_no_overlap", "use_conservative_scale_overload_checker", b"use_conservative_scale_overload_checker", "use_disjunctive_constraint_in_cumulative", b"use_disjunctive_constraint_in_cumulative", "use_dual_scheduling_heuristics", b"use_dual_scheduling_heuristics", "use_dynamic_precedence_in_cumulative", b"use_dynamic_precedence_in_cumulative", "use_dynamic_precedence_in_disjunctive", b"use_dynamic_precedence_in_disjunctive", "use_energetic_reasoning_in_no_overlap_2d", b"use_energetic_reasoning_in_no_overlap_2d", "use_erwa_heuristic", b"use_erwa_heuristic", "use_exact_lp_reason", b"use_exact_lp_reason", "use_extended_probing", b"use_extended_probing", "use_feasibility_jump", b"use_feasibility_jump", "use_feasibility_pump", b"use_feasibility_pump", "use_hard_precedences_in_cumulative", b"use_hard_precedences_in_cumulative", "use_implied_bounds", b"use_implied_bounds", "use_lb_relax_lns", b"use_lb_relax_lns", "use_lns", b"use_lns", "use_lns_only", b"use_lns_only", "use_ls_only", b"use_ls_only", "use_objective_lb_search", b"use_objective_lb_search", "use_objective_shaving_search", b"use_objective_shaving_search", "use_optimization_hints", b"use_optimization_hints", "use_optional_variables", b"use_optional_variables", "use_overload_checker_in_cumulative", b"use_overload_checker_in_cumulative", "use_pb_resolution", b"use_pb_resolution", "use_phase_saving", b"use_phase_saving", "use_precedences_in_disjunctive_constraint", b"use_precedences_in_disjunctive_constraint", "use_probing_search", b"use_probing_search", "use_rins_lns", b"use_rins_lns", "use_sat_inprocessing", b"use_sat_inprocessing", "use_shared_tree_search", b"use_shared_tree_search", "use_shaving_in_probing_search", b"use_shaving_in_probing_search", "use_strong_propagation_in_disjunctive", b"use_strong_propagation_in_disjunctive", "use_symmetry_in_lp", b"use_symmetry_in_lp", "use_timetable_edge_finding_in_cumulative", b"use_timetable_edge_finding_in_cumulative", "use_timetabling_in_no_overlap_2d", b"use_timetabling_in_no_overlap_2d", "use_try_edge_reasoning_in_no_overlap_2d", b"use_try_edge_reasoning_in_no_overlap_2d", "use_variables_shaving_search", b"use_variables_shaving_search", "variable_activity_decay", b"variable_activity_decay", "violation_ls_compound_move_probability", b"violation_ls_compound_move_probability", "violation_ls_perturbation_period", b"violation_ls_perturbation_period"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["absolute_gap_limit", b"absolute_gap_limit", "add_cg_cuts", b"add_cg_cuts", "add_clique_cuts", b"add_clique_cuts", "add_lin_max_cuts", b"add_lin_max_cuts", "add_lp_constraints_lazily", b"add_lp_constraints_lazily", "add_mir_cuts", b"add_mir_cuts", "add_objective_cut", b"add_objective_cut", "add_rlt_cuts", b"add_rlt_cuts", "add_zero_half_cuts", b"add_zero_half_cuts", "also_bump_variables_in_conflict_reasons", b"also_bump_variables_in_conflict_reasons", "at_most_one_max_expansion_size", b"at_most_one_max_expansion_size", "auto_detect_greater_than_at_least_one_of", b"auto_detect_greater_than_at_least_one_of", "binary_minimization_algorithm", b"binary_minimization_algorithm", "binary_search_num_conflicts", b"binary_search_num_conflicts", "blocking_restart_multiplier", b"blocking_restart_multiplier", "blocking_restart_window_size", b"blocking_restart_window_size", "boolean_encoding_level", b"boolean_encoding_level", "catch_sigint_signal", b"catch_sigint_signal", "clause_activity_decay", b"clause_activity_decay", "clause_cleanup_lbd_bound", b"clause_cleanup_lbd_bound", "clause_cleanup_ordering", b"clause_cleanup_ordering", "clause_cleanup_period", b"clause_cleanup_period", "clause_cleanup_protection", b"clause_cleanup_protection", "clause_cleanup_ratio", b"clause_cleanup_ratio", "clause_cleanup_target", b"clause_cleanup_target", "convert_intervals", b"convert_intervals", "core_minimization_level", b"core_minimization_level", "count_assumption_levels_in_lbd", b"count_assumption_levels_in_lbd", "cover_optimization", b"cover_optimization", "cp_model_presolve", b"cp_model_presolve", "cp_model_probing_level", b"cp_model_probing_level", "cp_model_use_sat_presolve", b"cp_model_use_sat_presolve", "cut_active_count_decay", b"cut_active_count_decay", "cut_cleanup_target", b"cut_cleanup_target", "cut_level", b"cut_level", "cut_max_active_count_value", b"cut_max_active_count_value", "debug_crash_if_presolve_breaks_hint", b"debug_crash_if_presolve_breaks_hint", "debug_crash_on_bad_hint", b"debug_crash_on_bad_hint", "debug_max_num_presolve_operations", b"debug_max_num_presolve_operations", "debug_postsolve_with_full_solver", b"debug_postsolve_with_full_solver", "default_restart_algorithms", b"default_restart_algorithms", "detect_linearized_product", b"detect_linearized_product", "detect_table_with_cost", b"detect_table_with_cost", "disable_constraint_expansion", b"disable_constraint_expansion", "diversify_lns_params", b"diversify_lns_params", "encode_complex_linear_constraint_with_integer", b"encode_complex_linear_constraint_with_integer", "encode_cumulative_as_reservoir", b"encode_cumulative_as_reservoir", "enumerate_all_solutions", b"enumerate_all_solutions", "expand_alldiff_constraints", b"expand_alldiff_constraints", "expand_reservoir_constraints", b"expand_reservoir_constraints", "expand_reservoir_using_circuit", b"expand_reservoir_using_circuit", "exploit_all_lp_solution", b"exploit_all_lp_solution", "exploit_all_precedences", b"exploit_all_precedences", "exploit_best_solution", b"exploit_best_solution", "exploit_integer_lp_solution", b"exploit_integer_lp_solution", "exploit_objective", b"exploit_objective", "exploit_relaxation_solution", b"exploit_relaxation_solution", "extra_subsolvers", b"extra_subsolvers", "feasibility_jump_batch_dtime", b"feasibility_jump_batch_dtime", "feasibility_jump_decay", b"feasibility_jump_decay", "feasibility_jump_enable_restarts", b"feasibility_jump_enable_restarts", "feasibility_jump_linearization_level", b"feasibility_jump_linearization_level", "feasibility_jump_max_expanded_constraint_size", b"feasibility_jump_max_expanded_constraint_size", "feasibility_jump_restart_factor", b"feasibility_jump_restart_factor", "feasibility_jump_var_perburbation_range_ratio", b"feasibility_jump_var_perburbation_range_ratio", "feasibility_jump_var_randomization_probability", b"feasibility_jump_var_randomization_probability", "fill_additional_solutions_in_response", b"fill_additional_solutions_in_response", "fill_tightened_domains_in_response", b"fill_tightened_domains_in_response", "filter_subsolvers", b"filter_subsolvers", "find_big_linear_overlap", b"find_big_linear_overlap", "find_multiple_cores", b"find_multiple_cores", "fix_variables_to_their_hinted_value", b"fix_variables_to_their_hinted_value", "fp_rounding", b"fp_rounding", "glucose_decay_increment", b"glucose_decay_increment", "glucose_decay_increment_period", b"glucose_decay_increment_period", "glucose_max_decay", b"glucose_max_decay", "hint_conflict_limit", b"hint_conflict_limit", "ignore_names", b"ignore_names", "ignore_subsolvers", b"ignore_subsolvers", "infer_all_diffs", b"infer_all_diffs", "initial_polarity", b"initial_polarity", "initial_variables_activity", b"initial_variables_activity", "inprocessing_dtime_ratio", b"inprocessing_dtime_ratio", "inprocessing_minimization_dtime", b"inprocessing_minimization_dtime", "inprocessing_minimization_use_all_orderings", b"inprocessing_minimization_use_all_orderings", "inprocessing_minimization_use_conflict_analysis", b"inprocessing_minimization_use_conflict_analysis", "inprocessing_probing_dtime", b"inprocessing_probing_dtime", "instantiate_all_variables", b"instantiate_all_variables", "interleave_batch_size", b"interleave_batch_size", "interleave_search", b"interleave_search", "keep_all_feasible_solutions_in_presolve", b"keep_all_feasible_solutions_in_presolve", "keep_symmetry_in_presolve", b"keep_symmetry_in_presolve", "lb_relax_num_workers_threshold", b"lb_relax_num_workers_threshold", "linear_split_size", b"linear_split_size", "linearization_level", b"linearization_level", "lns_initial_deterministic_limit", b"lns_initial_deterministic_limit", "lns_initial_difficulty", b"lns_initial_difficulty", "log_prefix", b"log_prefix", "log_search_progress", b"log_search_progress", "log_subsolver_statistics", b"log_subsolver_statistics", "log_to_response", b"log_to_response", "log_to_stdout", b"log_to_stdout", "lp_dual_tolerance", b"lp_dual_tolerance", "lp_primal_tolerance", b"lp_primal_tolerance", "max_all_diff_cut_size", b"max_all_diff_cut_size", "max_clause_activity_value", b"max_clause_activity_value", "max_consecutive_inactive_count", b"max_consecutive_inactive_count", "max_cut_rounds_at_level_zero", b"max_cut_rounds_at_level_zero", "max_deterministic_time", b"max_deterministic_time", "max_domain_size_when_encoding_eq_neq_constraints", b"max_domain_size_when_encoding_eq_neq_constraints", "max_integer_rounding_scaling", b"max_integer_rounding_scaling", "max_lin_max_size_for_expansion", b"max_lin_max_size_for_expansion", "max_memory_in_mb", b"max_memory_in_mb", "max_num_cuts", b"max_num_cuts", "max_num_deterministic_batches", b"max_num_deterministic_batches", "max_num_intervals_for_timetable_edge_finding", b"max_num_intervals_for_timetable_edge_finding", "max_number_of_conflicts", b"max_number_of_conflicts", "max_pairs_pairwise_reasoning_in_no_overlap_2d", b"max_pairs_pairwise_reasoning_in_no_overlap_2d", "max_presolve_iterations", b"max_presolve_iterations", "max_sat_assumption_order", b"max_sat_assumption_order", "max_sat_reverse_assumption_order", b"max_sat_reverse_assumption_order", "max_sat_stratification", b"max_sat_stratification", "max_size_to_create_precedence_literals_in_disjunctive", b"max_size_to_create_precedence_literals_in_disjunctive", "max_time_in_seconds", b"max_time_in_seconds", "max_variable_activity_value", b"max_variable_activity_value", "maximum_regions_to_split_in_disconnected_no_overlap_2d", b"maximum_regions_to_split_in_disconnected_no_overlap_2d", "merge_at_most_one_work_limit", b"merge_at_most_one_work_limit", "merge_no_overlap_work_limit", b"merge_no_overlap_work_limit", "min_orthogonality_for_lp_constraints", b"min_orthogonality_for_lp_constraints", "minimization_algorithm", b"minimization_algorithm", "minimize_reduction_during_pb_resolution", b"minimize_reduction_during_pb_resolution", "minimize_shared_clauses", b"minimize_shared_clauses", "mip_automatically_scale_variables", b"mip_automatically_scale_variables", "mip_check_precision", b"mip_check_precision", "mip_compute_true_objective_bound", b"mip_compute_true_objective_bound", "mip_drop_tolerance", b"mip_drop_tolerance", "mip_max_activity_exponent", b"mip_max_activity_exponent", "mip_max_bound", b"mip_max_bound", "mip_max_valid_magnitude", b"mip_max_valid_magnitude", "mip_presolve_level", b"mip_presolve_level", "mip_scale_large_domain", b"mip_scale_large_domain", "mip_treat_high_magnitude_bounds_as_infinity", b"mip_treat_high_magnitude_bounds_as_infinity", "mip_var_scaling", b"mip_var_scaling", "mip_wanted_precision", b"mip_wanted_precision", "name", b"name", "new_constraints_batch_size", b"new_constraints_batch_size", "new_linear_propagation", b"new_linear_propagation", "num_conflicts_before_strategy_changes", b"num_conflicts_before_strategy_changes", "num_full_subsolvers", b"num_full_subsolvers", "num_search_workers", b"num_search_workers", "num_violation_ls", b"num_violation_ls", "num_workers", b"num_workers", "only_add_cuts_at_level_zero", b"only_add_cuts_at_level_zero", "only_solve_ip", b"only_solve_ip", "optimize_with_core", b"optimize_with_core", "optimize_with_lb_tree_search", b"optimize_with_lb_tree_search", "optimize_with_max_hs", b"optimize_with_max_hs", "pb_cleanup_increment", b"pb_cleanup_increment", "pb_cleanup_ratio", b"pb_cleanup_ratio", "permute_presolve_constraint_order", b"permute_presolve_constraint_order", "permute_variable_randomly", b"permute_variable_randomly", "polarity_exploit_ls_hints", b"polarity_exploit_ls_hints", "polarity_rephase_increment", b"polarity_rephase_increment", "polish_lp_solution", b"polish_lp_solution", "preferred_variable_order", b"preferred_variable_order", "presolve_blocked_clause", b"presolve_blocked_clause", "presolve_bva_threshold", b"presolve_bva_threshold", "presolve_bve_clause_weight", b"presolve_bve_clause_weight", "presolve_bve_threshold", b"presolve_bve_threshold", "presolve_extract_integer_enforcement", b"presolve_extract_integer_enforcement", "presolve_inclusion_work_limit", b"presolve_inclusion_work_limit", "presolve_probing_deterministic_time_limit", b"presolve_probing_deterministic_time_limit", "presolve_substitution_level", b"presolve_substitution_level", "presolve_use_bva", b"presolve_use_bva", "probing_deterministic_time_limit", b"probing_deterministic_time_limit", "probing_num_combinations_limit", b"probing_num_combinations_limit", "propagation_loop_detection_factor", b"propagation_loop_detection_factor", "pseudo_cost_reliability_threshold", b"pseudo_cost_reliability_threshold", "push_all_tasks_toward_start", b"push_all_tasks_toward_start", "random_branches_ratio", b"random_branches_ratio", "random_polarity_ratio", b"random_polarity_ratio", "random_seed", b"random_seed", "randomize_search", b"randomize_search", "relative_gap_limit", b"relative_gap_limit", "remove_fixed_variables_early", b"remove_fixed_variables_early", "repair_hint", b"repair_hint", "restart_algorithms", b"restart_algorithms", "restart_dl_average_ratio", b"restart_dl_average_ratio", "restart_lbd_average_ratio", b"restart_lbd_average_ratio", "restart_period", b"restart_period", "restart_running_window_size", b"restart_running_window_size", "root_lp_iterations", b"root_lp_iterations", "routing_cut_dp_effort", b"routing_cut_dp_effort", "routing_cut_subset_size_for_binary_relation_bound", b"routing_cut_subset_size_for_binary_relation_bound", "routing_cut_subset_size_for_tight_binary_relation_bound", b"routing_cut_subset_size_for_tight_binary_relation_bound", "save_lp_basis_in_lb_tree_search", b"save_lp_basis_in_lb_tree_search", "search_branching", b"search_branching", "search_random_variable_pool_size", b"search_random_variable_pool_size", "share_binary_clauses", b"share_binary_clauses", "share_glue_clauses", b"share_glue_clauses", "share_level_zero_bounds", b"share_level_zero_bounds", "share_objective_bounds", b"share_objective_bounds", "shared_tree_balance_tolerance", b"shared_tree_balance_tolerance", "shared_tree_max_nodes_per_worker", b"shared_tree_max_nodes_per_worker", "shared_tree_num_workers", b"shared_tree_num_workers", "shared_tree_open_leaves_per_worker", b"shared_tree_open_leaves_per_worker", "shared_tree_split_strategy", b"shared_tree_split_strategy", "shared_tree_worker_enable_phase_sharing", b"shared_tree_worker_enable_phase_sharing", "shared_tree_worker_enable_trail_sharing", b"shared_tree_worker_enable_trail_sharing", "shared_tree_worker_min_restarts_per_subtree", b"shared_tree_worker_min_restarts_per_subtree", "shaving_search_deterministic_time", b"shaving_search_deterministic_time", "shaving_search_threshold", b"shaving_search_threshold", "solution_pool_size", b"solution_pool_size", "stop_after_first_solution", b"stop_after_first_solution", "stop_after_presolve", b"stop_after_presolve", "stop_after_root_propagation", b"stop_after_root_propagation", "strategy_change_increase_ratio", b"strategy_change_increase_ratio", "subsolver_params", b"subsolver_params", "subsolvers", b"subsolvers", "subsumption_during_conflict_analysis", b"subsumption_during_conflict_analysis", "symmetry_detection_deterministic_time_limit", b"symmetry_detection_deterministic_time_limit", "symmetry_level", b"symmetry_level", "table_compression_level", b"table_compression_level", "use_absl_random", b"use_absl_random", "use_all_different_for_circuit", b"use_all_different_for_circuit", "use_area_energetic_reasoning_in_no_overlap_2d", b"use_area_energetic_reasoning_in_no_overlap_2d", "use_blocking_restart", b"use_blocking_restart", "use_combined_no_overlap", b"use_combined_no_overlap", "use_conservative_scale_overload_checker", b"use_conservative_scale_overload_checker", "use_disjunctive_constraint_in_cumulative", b"use_disjunctive_constraint_in_cumulative", "use_dual_scheduling_heuristics", b"use_dual_scheduling_heuristics", "use_dynamic_precedence_in_cumulative", b"use_dynamic_precedence_in_cumulative", "use_dynamic_precedence_in_disjunctive", b"use_dynamic_precedence_in_disjunctive", "use_energetic_reasoning_in_no_overlap_2d", b"use_energetic_reasoning_in_no_overlap_2d", "use_erwa_heuristic", b"use_erwa_heuristic", "use_exact_lp_reason", b"use_exact_lp_reason", "use_extended_probing", b"use_extended_probing", "use_feasibility_jump", b"use_feasibility_jump", "use_feasibility_pump", b"use_feasibility_pump", "use_hard_precedences_in_cumulative", b"use_hard_precedences_in_cumulative", "use_implied_bounds", b"use_implied_bounds", "use_lb_relax_lns", b"use_lb_relax_lns", "use_lns", b"use_lns", "use_lns_only", b"use_lns_only", "use_ls_only", b"use_ls_only", "use_objective_lb_search", b"use_objective_lb_search", "use_objective_shaving_search", b"use_objective_shaving_search", "use_optimization_hints", b"use_optimization_hints", "use_optional_variables", b"use_optional_variables", "use_overload_checker_in_cumulative", b"use_overload_checker_in_cumulative", "use_pb_resolution", b"use_pb_resolution", "use_phase_saving", b"use_phase_saving", "use_precedences_in_disjunctive_constraint", b"use_precedences_in_disjunctive_constraint", "use_probing_search", b"use_probing_search", "use_rins_lns", b"use_rins_lns", "use_sat_inprocessing", b"use_sat_inprocessing", "use_shared_tree_search", b"use_shared_tree_search", "use_shaving_in_probing_search", b"use_shaving_in_probing_search", "use_strong_propagation_in_disjunctive", b"use_strong_propagation_in_disjunctive", "use_symmetry_in_lp", b"use_symmetry_in_lp", "use_timetable_edge_finding_in_cumulative", b"use_timetable_edge_finding_in_cumulative", "use_timetabling_in_no_overlap_2d", b"use_timetabling_in_no_overlap_2d", "use_try_edge_reasoning_in_no_overlap_2d", b"use_try_edge_reasoning_in_no_overlap_2d", "use_variables_shaving_search", b"use_variables_shaving_search", "variable_activity_decay", b"variable_activity_decay", "violation_ls_compound_move_probability", b"violation_ls_compound_move_probability", "violation_ls_perturbation_period", b"violation_ls_perturbation_period"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___SatParameters: _TypeAlias = SatParameters  # noqa: Y015
