...
public:
    ...
    virtual std::string DebugString() const;
    virtual void Apply(operations_research::Solver *s);
    virtual void Refute(operations_research::Solver *s);
...
public:
    ...
    virtual std::string DebugString() const;
    virtual operations_research::Decision *Next(operations_research::Solver *s);
...
public:
    ...
    virtual std::string DebugString() const;
    virtual void Run(operations_research::Solver *s);
...
public:
    ...
    virtual void Accept(operations_research::ModelVisitor *visitor) const;
...
public:
    ...
    virtual void BeginNextDecision(operations_research::DecisionBuilder *b);
    virtual void EndNextDecision(operations_research::DecisionBuilder *b, operations_research::Decision *d);
    virtual void ApplyDecision(operations_research::Decision *d);
    virtual void RefuteDecision(operations_research::Decision *d);
    virtual void AfterDecision(operations_research::Decision *d, bool apply);
