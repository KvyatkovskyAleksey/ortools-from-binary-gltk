...
@_typing.final
class FirstSolutionStrategy(_message.Message):
    ...
    class _ValueEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[FirstSolutionStrategy._Value.ValueType], _builtins.type):
...
Global___FirstSolutionStrategy: _TypeAlias = FirstSolutionStrategy  # noqa: Y015

@_typing.final
class LocalSearchMetaheuristic(_message.Message):
    ...
    class _ValueEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[LocalSearchMetaheuristic._Value.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
...
Global___LocalSearchMetaheuristic: _TypeAlias = LocalSearchMetaheuristic  # noqa: Y015

@_typing.final
class RoutingSearchStatus(_message.Message):
    ...
    class _ValueEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[RoutingSearchStatus._Value.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
...
Global___RoutingSearchStatus: _TypeAlias = RoutingSearchStatus  # noqa: Y015
