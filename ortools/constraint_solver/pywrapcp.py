...
class Solver(object):
    ...
    def TabuSearch(self, maximize: "bool", objective: "IntVar", step: "int64_t", vars: "std::vector< operations_research::IntVar * > const &", keep_tenure: "int64_t", forbid_tenure: "int64_t", tabu_factor: "double") -> "operations_research::ObjectiveMonitor *":
    ...
    def SimulatedAnnealing(self, maximize: "bool", v: "IntVar", step: "int64_t", initial_temperature: "int64_t") -> "operations_research::ObjectiveMonitor *":
    ...
    def ScheduleOrPostpone(self, var: "IntervalVar", est: "int64_t", marker: "int64_t *") -> "operations_research::Decision *":
    ...
    def ScheduleOrExpedite(self, var: "IntervalVar", est: "int64_t", marker: "int64_t *") -> "operations_research::Decision *":
    ...
    def TopProgressPercent(self) -> "int":
        r""" Returns a percentage representing the propress of the search before reaching the limits of the top-level search (can be called from a nested solve)."""
    ...
    def Accept(self, visitor: "operations_research::ModelVisitor *") -> "void":
...
class SearchMonitor(BaseObject):
    ...
    def ProgressPercent(self) -> "int":
        r""" Returns a percentage representing the propress of the search before reaching limits."""
...
class IntVarLocalSearchOperator(LocalSearchOperator):
    r""" Specialization of LocalSearchOperator built from an array of IntVars which specifies the scope of the operator. This class also takes care of storing current variable values in Start(), keeps track of changes done by the operator and builds the delta. The Deactivate() method can be used to perform Large Neighborhood Search."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, vars: "std::vector< operations_research::IntVar * > const &", keep_inverse_values: "bool"=False):
    ...
    def Value(self, index: "int64_t") -> "int64_t":
...
class LocalSearchFilterManager(BaseObject):
    ...
    def Accept(self, monitor: "operations_research::LocalSearchMonitor *", delta: "Assignment", deltadelta: "Assignment", objective_min: "int64_t", objective_max: "int64_t") -> "bool":
...
class PathsMetadata(object):
    ...
    def IsStart(self, node: "int64_t") -> "bool":
        return _pywrapcp.PathsMetadata_IsStart(self, node)

    def IsEnd(self, node: "int64_t") -> "bool":
        return _pywrapcp.PathsMetadata_IsEnd(self, node)

    def GetPath(self, start_or_end_node: "int64_t") -> "int":
    ...
    def Paths(self) -> "std::vector< int64_t > const &":
        return _pywrapcp.PathsMetadata_Paths(self)

    def Starts(self) -> "std::vector< int64_t > const &":
        return _pywrapcp.PathsMetadata_Starts(self)

    def Ends(self) -> "std::vector< int64_t > const &":
...
class RoutingModel(object):
    ...
    r""" Problem solved successfully after calling RoutingModel::Solve(), except that a local optimum has not been reached. Leaving more time would allow improving the solution."""
    ...
    def RegisterUnaryTransitVector(self, values: "std::vector< int64_t >") -> "int":
        r""" Registers 'callback' and returns its index. The sign parameter allows to notify the solver that the callback only return values of the given sign. This can help the solver, but passing an incorrect sign may crash in non-opt compilation mode, and yield incorrect results in opt."""
        return _pywrapcp.RoutingModel_RegisterUnaryTransitVector(self, values)

    def RegisterUnaryTransitCallback(self, *args) -> "int":
    ...
    def RegisterTransitCallback(self, *args) -> "int":
    ...
    def AddResourceGroup(self) -> "int":
        r""" Adds a resource group to the routing model. Returns its index in resource_groups_."""
    ...
    def GetDimensionResourceGroupIndex(self, dimension: "RoutingDimension") -> "int":
        r""" Returns the index of the resource group attached to the dimension. DCHECKS that there's exactly one resource group for this dimension."""
    ...
    def HasMandatoryDisjunctions(self) -> "bool":
        r""" Returns true if the model contains mandatory disjunctions (ones with kNoPenalty as penalty)."""
        return _pywrapcp.RoutingModel_HasMandatoryDisjunctions(self)

    def HasMaxCardinalityConstrainedDisjunctions(self) -> "bool":
        r""" Returns true if the model contains at least one disjunction which is constrained by its max_cardinality."""
    ...
    def GetPickupPositions(self, node_index: "int64_t") -> "std::vector< operations_research::RoutingModel::PickupDeliveryPosition > const &":
    ...
    def GetDeliveryPositions(self, node_index: "int64_t") -> "std::vector< operations_research::RoutingModel::PickupDeliveryPosition > const &":
    ...
    def SetPathEnergyCostOfVehicle(self, force: "std::string const &", distance: "std::string const &", unit_cost: "int64_t", vehicle: "int") -> "void":
    ...
    def AddAtSolutionCallback(self, callback: "std::function< void () >", track_unchecked_neighbors: "bool"=False) -> "void":
        r""" Adds a callback called each time a solution is found during the search. This is a shortcut to creating a monitor to call the callback on AtSolution() and adding it with AddSearchMonitor. If track_unchecked_neighbors is true, the callback will also be called on AcceptUncheckedNeighbor() events, which is useful to grab solutions obtained when solver_parameters.check_solution_period > 1 (aka fastLS)."""
    ...
    def AddWeightedVariableMaximizedByFinalizer(self, var: "IntVar", cost: "int64_t") -> "void":
        r""" Adds a variable to maximize in the solution finalizer, with a weighted priority: the higher the more priority it has."""
    ...
    def AddWeightedVariableTargetToFinalizer(self, var: "IntVar", target: "int64_t", cost: "int64_t") -> "void":
        r""" Same as above with a weighted priority: the higher the cost, the more priority it has to be set close to the target value."""
    ...
    def objective_lower_bound(self) -> "int64_t":
        r""" Returns the current lower bound found by internal solvers during the search."""
    ...
    def PreAssignment(self) -> "operations_research::Assignment const *":
    ...
    def AssignmentToRoutes(self, assignment: "Assignment", routes: "std::vector< std::vector< int64_t > > *") -> "void":
    ...
    def GetOrCreateNodeNeighborsByCostClass(self, *args) -> "operations_research::RoutingModel::NodeNeighborsByCostClass const *":
        r"""
        *Overload 1:*
    ...
    def VehicleRouteConsideredVar(self, vehicle: "int") -> "operations_research::IntVar *":
        r""" Returns the variable specifying whether or not the given vehicle route is considered for costs and constraints. It will be equal to 1 iff the route of the vehicle is not empty OR vehicle_used_when_empty_[vehicle] is true."""
    ...
    def ResourceVar(self, vehicle: "int", resource_group: "int") -> "operations_research::IntVar *":
        r""" Returns the resource variable for the given vehicle index in the given resource group. If a vehicle doesn't require a resource from the corresponding resource group, then ResourceVar(v, r_g) == -1."""
    ...
    def CheckIfAssignmentIsFeasible(self, assignment: "Assignment", call_at_solution_monitors: "bool") -> "bool":
        r""" Returns a vector cumul_bounds, for which cumul_bounds[i][j] is a pair containing the minimum and maximum of the CumulVar of the jth node on route i. - cumul_bounds[i][j].first is the minimum. - cumul_bounds[i][j].second is the maximum. Checks if an assignment is feasible."""
        return _pywrapcp.RoutingModel_CheckIfAssignmentIsFeasible(self, assignment, call_at_solution_monitors)

    def solver(self) -> "operations_research::Solver *":
        r""" Returns the underlying constraint solver. Can be used to add extra constraints and/or modify search algorithms."""
        return _pywrapcp.RoutingModel_solver(self)

    def CheckLimit(self, *args) -> "bool":
        r""" Returns true if the search limit has been crossed with the given time offset."""
    ...
    def AreRoutesInterdependent(self, parameters: "operations_research::RoutingSearchParameters const &") -> "bool":
        r""" Returns true if routes are interdependent. This means that any modification to a route might impact another."""
    ...
    def GetPathsMetadata(self) -> "operations_research::PathsMetadata const &":
...
class SimpleBoundCosts(object):
    ...
    def __init__(self, num_bounds: "int", default_bound_cost: "BoundCost"):
        _pywrapcp.SimpleBoundCosts_swiginit(self, _pywrapcp.new_SimpleBoundCosts(num_bounds, default_bound_cost))

    def bound_cost(self, element: "int") -> "operations_research::BoundCost":
...
class RoutingDimension(object):
    ...
    def SetSoftSpanUpperBoundForVehicle(self, bound_cost: "BoundCost", vehicle: "int") -> "void":
        r""" If the span of vehicle on this dimension is larger than bound, the cost will be increased by cost * (span - bound)."""
        return _pywrapcp.RoutingDimension_SetSoftSpanUpperBoundForVehicle(self, bound_cost, vehicle)

    def HasSoftSpanUpperBounds(self) -> "bool":
        return _pywrapcp.RoutingDimension_HasSoftSpanUpperBounds(self)

    def GetSoftSpanUpperBoundForVehicle(self, vehicle: "int") -> "operations_research::BoundCost":
        return _pywrapcp.RoutingDimension_GetSoftSpanUpperBoundForVehicle(self, vehicle)

    def SetQuadraticCostSoftSpanUpperBoundForVehicle(self, bound_cost: "BoundCost", vehicle: "int") -> "void":
        r""" If the span of vehicle on this dimension is larger than bound, the cost will be increased by cost * (span - bound)^2."""
        return _pywrapcp.RoutingDimension_SetQuadraticCostSoftSpanUpperBoundForVehicle(self, bound_cost, vehicle)

    def HasQuadraticCostSoftSpanUpperBounds(self) -> "bool":
        return _pywrapcp.RoutingDimension_HasQuadraticCostSoftSpanUpperBounds(self)

    def GetQuadraticCostSoftSpanUpperBoundForVehicle(self, vehicle: "int") -> "operations_research::BoundCost":
