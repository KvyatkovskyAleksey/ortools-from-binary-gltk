...
@_typing.final
class BopOptimizerMethod(_message.Message):
    ...
    class _OptimizerTypeEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[BopOptimizerMethod._OptimizerType.ValueType], _builtins.type):
...
Global___BopOptimizerMethod: _TypeAlias = BopOptimizerMethod  # noqa: Y015

@_typing.final
class BopSolverOptimizerSet(_message.Message):
    ...
    @_builtins.property
    def methods(self) -> _containers.RepeatedCompositeFieldContainer[Global___BopOptimizerMethod]: ...
    def __init__(
        self,
        *,
        methods: _abc.Iterable[Global___BopOptimizerMethod] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["methods", b"methods"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___BopSolverOptimizerSet: _TypeAlias = BopSolverOptimizerSet  # noqa: Y015

@_typing.final
class BopParameters(_message.Message):
    ...
    class _ThreadSynchronizationTypeEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[BopParameters._ThreadSynchronizationType.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    LP_MAX_DETERMINISTIC_TIME_FIELD_NUMBER: _builtins.int
    MAX_NUMBER_OF_CONSECUTIVE_FAILING_OPTIMIZER_CALLS_FIELD_NUMBER: _builtins.int
    RELATIVE_GAP_LIMIT_FIELD_NUMBER: _builtins.int
    MAX_NUM_DECISIONS_IN_LS_FIELD_NUMBER: _builtins.int
    MAX_NUM_BROKEN_CONSTRAINTS_IN_LS_FIELD_NUMBER: _builtins.int
    LOG_SEARCH_PROGRESS_FIELD_NUMBER: _builtins.int
    COMPUTE_ESTIMATED_IMPACT_FIELD_NUMBER: _builtins.int
    PRUNE_SEARCH_TREE_FIELD_NUMBER: _builtins.int
    SORT_CONSTRAINTS_BY_NUM_TERMS_FIELD_NUMBER: _builtins.int
    USE_RANDOM_LNS_FIELD_NUMBER: _builtins.int
    RANDOM_SEED_FIELD_NUMBER: _builtins.int
    NUM_RELAXED_VARS_FIELD_NUMBER: _builtins.int
    MAX_NUMBER_OF_CONFLICTS_IN_RANDOM_LNS_FIELD_NUMBER: _builtins.int
    NUM_RANDOM_LNS_TRIES_FIELD_NUMBER: _builtins.int
    MAX_NUMBER_OF_BACKTRACKS_IN_LS_FIELD_NUMBER: _builtins.int
    USE_LP_LNS_FIELD_NUMBER: _builtins.int
    USE_SAT_TO_CHOOSE_LNS_NEIGHBOURHOOD_FIELD_NUMBER: _builtins.int
    MAX_NUMBER_OF_CONFLICTS_FOR_QUICK_CHECK_FIELD_NUMBER: _builtins.int
    USE_SYMMETRY_FIELD_NUMBER: _builtins.int
    EXPLOIT_SYMMETRY_IN_SAT_FIRST_SOLUTION_FIELD_NUMBER: _builtins.int
    MAX_NUMBER_OF_CONFLICTS_IN_RANDOM_SOLUTION_GENERATION_FIELD_NUMBER: _builtins.int
    MAX_NUMBER_OF_EXPLORED_ASSIGNMENTS_PER_TRY_IN_LS_FIELD_NUMBER: _builtins.int
    USE_TRANSPOSITION_TABLE_IN_LS_FIELD_NUMBER: _builtins.int
    USE_POTENTIAL_ONE_FLIP_REPAIRS_IN_LS_FIELD_NUMBER: _builtins.int
    USE_LEARNED_BINARY_CLAUSES_IN_LP_FIELD_NUMBER: _builtins.int
    NUMBER_OF_SOLVERS_FIELD_NUMBER: _builtins.int
    SYNCHRONIZATION_TYPE_FIELD_NUMBER: _builtins.int
    SOLVER_OPTIMIZER_SETS_FIELD_NUMBER: _builtins.int
    DEFAULT_SOLVER_OPTIMIZER_SETS_FIELD_NUMBER: _builtins.int
    USE_LP_STRONG_BRANCHING_FIELD_NUMBER: _builtins.int
    DECOMPOSER_NUM_VARIABLES_THRESHOLD_FIELD_NUMBER: _builtins.int
    NUM_BOP_SOLVERS_USED_BY_DECOMPOSITION_FIELD_NUMBER: _builtins.int
    DECOMPOSED_PROBLEM_MIN_TIME_IN_SECONDS_FIELD_NUMBER: _builtins.int
    GUIDED_SAT_CONFLICTS_CHUNK_FIELD_NUMBER: _builtins.int
    MAX_LP_SOLVE_FOR_FEASIBILITY_PROBLEMS_FIELD_NUMBER: _builtins.int
    ...
    is called.
    """
    lp_max_deterministic_time: _builtins.float
    ...
    """
    max_number_of_consecutive_failing_optimizer_calls: _builtins.int
    ...
    limit.
    """
    exploit_symmetry_in_sat_first_solution: _builtins.bool
    ...
    """
    max_number_of_conflicts_in_random_solution_generation: _builtins.int
    """The number of conflicts the SAT solver has to generate a random solution."""
    max_number_of_explored_assignments_per_try_in_ls: _builtins.int
    ...
    """
    use_transposition_table_in_ls: _builtins.bool
    ...
    """
    use_potential_one_flip_repairs_in_ls: _builtins.bool
    ...
    """
    use_learned_binary_clauses_in_lp: _builtins.bool
    """Whether we use the learned binary clauses in the Linear Relaxation."""
    number_of_solvers: _builtins.int
    ...
    default_solver_optimizer_sets: _builtins.str
    use_lp_strong_branching: _builtins.bool
    ...
    """
    decomposer_num_variables_threshold: _builtins.int
    """Only try to decompose the problem when the number of variables is greater
    than the threshold.
    """
    num_bop_solvers_used_by_decomposition: _builtins.int
    ...
    """
    decomposed_problem_min_time_in_seconds: _builtins.float
    ...
    """
    guided_sat_conflicts_chunk: _builtins.int
    ...
    """
    max_lp_solve_for_feasibility_problems: _builtins.int
    ...
    """
    @_builtins.property
    def solver_optimizer_sets(self) -> _containers.RepeatedCompositeFieldContainer[Global___BopSolverOptimizerSet]:
