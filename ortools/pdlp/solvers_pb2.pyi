...
from ortools.glop import parameters_pb2 as _parameters_pb2
...
class _OptimalityNormEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_OptimalityNorm.ValueType], _builtins.type):
...
residual <= eps_optimal_{X}_residual_absolute
          + eps_optimal_{X}_residual_relative * |bound|
"""
Global___OptimalityNorm: _TypeAlias = OptimalityNorm  # noqa: Y015

class _SchedulerType:
    ValueType = _typing.NewType("ValueType", _builtins.int)
    V: _TypeAlias = ValueType  # noqa: Y015

class _SchedulerTypeEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_SchedulerType.ValueType], _builtins.type):
    DESCRIPTOR: _descriptor.EnumDescriptor
...
<Eigen/ThreadPool>).
"""
Global___SchedulerType: _TypeAlias = SchedulerType  # noqa: Y015

@_typing.final
class TerminationCriteria(_message.Message):
    ...
    @_typing.final
    class SimpleOptimalityCriteria(_message.Message):
        ...
        EPS_OPTIMAL_ABSOLUTE_FIELD_NUMBER: _builtins.int
        EPS_OPTIMAL_RELATIVE_FIELD_NUMBER: _builtins.int
        eps_optimal_absolute: _builtins.float
        """Absolute tolerance on the primal residual, dual residual, and objective
        gap.
        """
        eps_optimal_relative: _builtins.float
        ...
        def __init__(
            self,
            *,
            eps_optimal_absolute: _builtins.float | None = ...,
            eps_optimal_relative: _builtins.float | None = ...,
        ) -> None: ...
        _HasFieldArgType: _TypeAlias = _typing.Literal["eps_optimal_absolute", b"eps_optimal_absolute", "eps_optimal_relative", b"eps_optimal_relative"]  # noqa: Y015
        def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
        _ClearFieldArgType: _TypeAlias = _typing.Literal["eps_optimal_absolute", b"eps_optimal_absolute", "eps_optimal_relative", b"eps_optimal_relative"]  # noqa: Y015
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

    @_typing.final
    class DetailedOptimalityCriteria(_message.Message):
        DESCRIPTOR: _descriptor.Descriptor

        EPS_OPTIMAL_PRIMAL_RESIDUAL_ABSOLUTE_FIELD_NUMBER: _builtins.int
        EPS_OPTIMAL_PRIMAL_RESIDUAL_RELATIVE_FIELD_NUMBER: _builtins.int
        EPS_OPTIMAL_DUAL_RESIDUAL_ABSOLUTE_FIELD_NUMBER: _builtins.int
        EPS_OPTIMAL_DUAL_RESIDUAL_RELATIVE_FIELD_NUMBER: _builtins.int
        EPS_OPTIMAL_OBJECTIVE_GAP_ABSOLUTE_FIELD_NUMBER: _builtins.int
        EPS_OPTIMAL_OBJECTIVE_GAP_RELATIVE_FIELD_NUMBER: _builtins.int
        eps_optimal_primal_residual_absolute: _builtins.float
        """Absolute tolerance on the primal residual."""
        eps_optimal_primal_residual_relative: _builtins.float
        """Relative tolerance on the primal residual."""
        eps_optimal_dual_residual_absolute: _builtins.float
        """Absolute tolerance on the dual residual."""
        eps_optimal_dual_residual_relative: _builtins.float
        """Relative tolerance on the dual residual."""
        eps_optimal_objective_gap_absolute: _builtins.float
        """Absolute tolerance on the objective gap."""
        eps_optimal_objective_gap_relative: _builtins.float
        """Relative tolerance on the objective gap."""
        def __init__(
            self,
            *,
            eps_optimal_primal_residual_absolute: _builtins.float | None = ...,
            eps_optimal_primal_residual_relative: _builtins.float | None = ...,
            eps_optimal_dual_residual_absolute: _builtins.float | None = ...,
            eps_optimal_dual_residual_relative: _builtins.float | None = ...,
            eps_optimal_objective_gap_absolute: _builtins.float | None = ...,
            eps_optimal_objective_gap_relative: _builtins.float | None = ...,
        ) -> None: ...
        _HasFieldArgType: _TypeAlias = _typing.Literal["eps_optimal_dual_residual_absolute", b"eps_optimal_dual_residual_absolute", "eps_optimal_dual_residual_relative", b"eps_optimal_dual_residual_relative", "eps_optimal_objective_gap_absolute", b"eps_optimal_objective_gap_absolute", "eps_optimal_objective_gap_relative", b"eps_optimal_objective_gap_relative", "eps_optimal_primal_residual_absolute", b"eps_optimal_primal_residual_absolute", "eps_optimal_primal_residual_relative", b"eps_optimal_primal_residual_relative"]  # noqa: Y015
        def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
        _ClearFieldArgType: _TypeAlias = _typing.Literal["eps_optimal_dual_residual_absolute", b"eps_optimal_dual_residual_absolute", "eps_optimal_dual_residual_relative", b"eps_optimal_dual_residual_relative", "eps_optimal_objective_gap_absolute", b"eps_optimal_objective_gap_absolute", "eps_optimal_objective_gap_relative", b"eps_optimal_objective_gap_relative", "eps_optimal_primal_residual_absolute", b"eps_optimal_primal_residual_absolute", "eps_optimal_primal_residual_relative", b"eps_optimal_primal_residual_relative"]  # noqa: Y015
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

    OPTIMALITY_NORM_FIELD_NUMBER: _builtins.int
    SIMPLE_OPTIMALITY_CRITERIA_FIELD_NUMBER: _builtins.int
    DETAILED_OPTIMALITY_CRITERIA_FIELD_NUMBER: _builtins.int
    EPS_OPTIMAL_ABSOLUTE_FIELD_NUMBER: _builtins.int
    EPS_OPTIMAL_RELATIVE_FIELD_NUMBER: _builtins.int
    EPS_PRIMAL_INFEASIBLE_FIELD_NUMBER: _builtins.int
    EPS_DUAL_INFEASIBLE_FIELD_NUMBER: _builtins.int
    TIME_SEC_LIMIT_FIELD_NUMBER: _builtins.int
    ITERATION_LIMIT_FIELD_NUMBER: _builtins.int
    KKT_MATRIX_PASS_LIMIT_FIELD_NUMBER: _builtins.int
    ...
    def eps_optimal_absolute(self) -> _builtins.float:
    ...
    @eps_optimal_absolute.setter
    @_deprecated("""This field has been marked as deprecated using proto field options.""")
    def eps_optimal_absolute(self, value: _builtins.float) -> None:
        """Absolute tolerance on primal residual, dual residual, and the objective
        gap.
        Deprecated, use simple_optimality_criteria instead.
        TODO(b/241462829) delete this deprecated field.
    ...
    @_builtins.property
    @_deprecated("""This field has been marked as deprecated using proto field options.""")
    def eps_optimal_relative(self) -> _builtins.float:
    ...
    @eps_optimal_relative.setter
    @_deprecated("""This field has been marked as deprecated using proto field options.""")
    def eps_optimal_relative(self, value: _builtins.float) -> None:
        """Relative tolerance on primal residual, dual residual, and the objective
        gap.
        Deprecated, use simple_optimality_criteria instead.
        TODO(b/241462829) delete this deprecated field.
    ...
    eps_primal_infeasible: _builtins.float
    ...
    """
    eps_dual_infeasible: _builtins.float
    ...
    def __init__(
        ...
        *,
        ...
        eps_optimal_absolute: _builtins.float | None = ...,
        eps_optimal_relative: _builtins.float | None = ...,
        eps_primal_infeasible: _builtins.float | None = ...,
        eps_dual_infeasible: _builtins.float | None = ...,
        time_sec_limit: _builtins.float | None = ...,
        iteration_limit: _builtins.int | None = ...,
        kkt_matrix_pass_limit: _builtins.float | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["detailed_optimality_criteria", b"detailed_optimality_criteria", "eps_dual_infeasible", b"eps_dual_infeasible", "eps_optimal_absolute", b"eps_optimal_absolute", "eps_optimal_relative", b"eps_optimal_relative", "eps_primal_infeasible", b"eps_primal_infeasible", "iteration_limit", b"iteration_limit", "kkt_matrix_pass_limit", b"kkt_matrix_pass_limit", "optimality_criteria", b"optimality_criteria", "optimality_norm", b"optimality_norm", "simple_optimality_criteria", b"simple_optimality_criteria", "time_sec_limit", b"time_sec_limit"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["detailed_optimality_criteria", b"detailed_optimality_criteria", "eps_dual_infeasible", b"eps_dual_infeasible", "eps_optimal_absolute", b"eps_optimal_absolute", "eps_optimal_relative", b"eps_optimal_relative", "eps_primal_infeasible", b"eps_primal_infeasible", "iteration_limit", b"iteration_limit", "kkt_matrix_pass_limit", b"kkt_matrix_pass_limit", "optimality_criteria", b"optimality_criteria", "optimality_norm", b"optimality_norm", "simple_optimality_criteria", b"simple_optimality_criteria", "time_sec_limit", b"time_sec_limit"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_optimality_criteria: _TypeAlias = _typing.Literal["simple_optimality_criteria", "detailed_optimality_criteria"]  # noqa: Y015
    _WhichOneofArgType_optimality_criteria: _TypeAlias = _typing.Literal["optimality_criteria", b"optimality_criteria"]  # noqa: Y015
    def WhichOneof(self, oneof_group: _WhichOneofArgType_optimality_criteria) -> _WhichOneofReturnType_optimality_criteria | None: ...

Global___TerminationCriteria: _TypeAlias = TerminationCriteria  # noqa: Y015

@_typing.final
class AdaptiveLinesearchParams(_message.Message):
    ...
    STEP_SIZE_REDUCTION_EXPONENT_FIELD_NUMBER: _builtins.int
    STEP_SIZE_GROWTH_EXPONENT_FIELD_NUMBER: _builtins.int
    step_size_reduction_exponent: _builtins.float
    ...
    """
    step_size_growth_exponent: _builtins.float
    ...
    def __init__(
        self,
        *,
        step_size_reduction_exponent: _builtins.float | None = ...,
        step_size_growth_exponent: _builtins.float | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["step_size_growth_exponent", b"step_size_growth_exponent", "step_size_reduction_exponent", b"step_size_reduction_exponent"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["step_size_growth_exponent", b"step_size_growth_exponent", "step_size_reduction_exponent", b"step_size_reduction_exponent"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___AdaptiveLinesearchParams: _TypeAlias = AdaptiveLinesearchParams  # noqa: Y015

@_typing.final
class MalitskyPockParams(_message.Message):
    DESCRIPTOR: _descriptor.Descriptor

    STEP_SIZE_DOWNSCALING_FACTOR_FIELD_NUMBER: _builtins.int
    LINESEARCH_CONTRACTION_FACTOR_FIELD_NUMBER: _builtins.int
    STEP_SIZE_INTERPOLATION_FIELD_NUMBER: _builtins.int
    step_size_downscaling_factor: _builtins.float
    ...
    """
    linesearch_contraction_factor: _builtins.float
    ...
    """
    step_size_interpolation: _builtins.float
    ...
    def __init__(
        self,
        *,
        step_size_downscaling_factor: _builtins.float | None = ...,
        linesearch_contraction_factor: _builtins.float | None = ...,
        step_size_interpolation: _builtins.float | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["linesearch_contraction_factor", b"linesearch_contraction_factor", "step_size_downscaling_factor", b"step_size_downscaling_factor", "step_size_interpolation", b"step_size_interpolation"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["linesearch_contraction_factor", b"linesearch_contraction_factor", "step_size_downscaling_factor", b"step_size_downscaling_factor", "step_size_interpolation", b"step_size_interpolation"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___MalitskyPockParams: _TypeAlias = MalitskyPockParams  # noqa: Y015

@_typing.final
class PrimalDualHybridGradientParams(_message.Message):
    ...
    class _RestartStrategyEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[PrimalDualHybridGradientParams._RestartStrategy.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    class _LinesearchRuleEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[PrimalDualHybridGradientParams._LinesearchRule.ValueType], _builtins.type):
        DESCRIPTOR: _descriptor.EnumDescriptor
    ...
    @_typing.final
    class PresolveOptions(_message.Message):
        DESCRIPTOR: _descriptor.Descriptor

        USE_GLOP_FIELD_NUMBER: _builtins.int
        GLOP_PARAMETERS_FIELD_NUMBER: _builtins.int
        use_glop: _builtins.bool
        ...
        """
        @_builtins.property
        def glop_parameters(self) -> _parameters_pb2.GlopParameters:
        ...
        def __init__(
            self,
            *,
            use_glop: _builtins.bool | None = ...,
            glop_parameters: _parameters_pb2.GlopParameters | None = ...,
        ) -> None: ...
        _HasFieldArgType: _TypeAlias = _typing.Literal["glop_parameters", b"glop_parameters", "use_glop", b"use_glop"]  # noqa: Y015
        def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
        _ClearFieldArgType: _TypeAlias = _typing.Literal["glop_parameters", b"glop_parameters", "use_glop", b"use_glop"]  # noqa: Y015
        def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

    TERMINATION_CRITERIA_FIELD_NUMBER: _builtins.int
    NUM_THREADS_FIELD_NUMBER: _builtins.int
    NUM_SHARDS_FIELD_NUMBER: _builtins.int
    SCHEDULER_TYPE_FIELD_NUMBER: _builtins.int
    RECORD_ITERATION_STATS_FIELD_NUMBER: _builtins.int
    VERBOSITY_LEVEL_FIELD_NUMBER: _builtins.int
    LOG_INTERVAL_SECONDS_FIELD_NUMBER: _builtins.int
    MAJOR_ITERATION_FREQUENCY_FIELD_NUMBER: _builtins.int
    TERMINATION_CHECK_FREQUENCY_FIELD_NUMBER: _builtins.int
    RESTART_STRATEGY_FIELD_NUMBER: _builtins.int
    PRIMAL_WEIGHT_UPDATE_SMOOTHING_FIELD_NUMBER: _builtins.int
    INITIAL_PRIMAL_WEIGHT_FIELD_NUMBER: _builtins.int
    PRESOLVE_OPTIONS_FIELD_NUMBER: _builtins.int
    L_INF_RUIZ_ITERATIONS_FIELD_NUMBER: _builtins.int
    L2_NORM_RESCALING_FIELD_NUMBER: _builtins.int
    SUFFICIENT_REDUCTION_FOR_RESTART_FIELD_NUMBER: _builtins.int
    NECESSARY_REDUCTION_FOR_RESTART_FIELD_NUMBER: _builtins.int
    LINESEARCH_RULE_FIELD_NUMBER: _builtins.int
    ADAPTIVE_LINESEARCH_PARAMETERS_FIELD_NUMBER: _builtins.int
    MALITSKY_POCK_PARAMETERS_FIELD_NUMBER: _builtins.int
    INITIAL_STEP_SIZE_SCALING_FIELD_NUMBER: _builtins.int
    RANDOM_PROJECTION_SEEDS_FIELD_NUMBER: _builtins.int
    INFINITE_CONSTRAINT_BOUND_THRESHOLD_FIELD_NUMBER: _builtins.int
    HANDLE_SOME_PRIMAL_GRADIENTS_ON_FINITE_BOUNDS_AS_RESIDUALS_FIELD_NUMBER: _builtins.int
    USE_DIAGONAL_QP_TRUST_REGION_SOLVER_FIELD_NUMBER: _builtins.int
    DIAGONAL_QP_TRUST_REGION_SOLVER_TOLERANCE_FIELD_NUMBER: _builtins.int
    USE_FEASIBILITY_POLISHING_FIELD_NUMBER: _builtins.int
    ...
    """
    record_iteration_stats: _builtins.bool
    ...
    """
    log_interval_seconds: _builtins.float
    ...
    """
    major_iteration_frequency: _builtins.int
    ...
    """
    termination_check_frequency: _builtins.int
    ...
    """
    primal_weight_update_smoothing: _builtins.float
    ...
    """
    initial_primal_weight: _builtins.float
    ...
    from 10^{-6} to 10^6.
    """
    l_inf_ruiz_iterations: _builtins.int
    ...
    """
    necessary_reduction_for_restart: _builtins.float
    ...
    """
    handle_some_primal_gradients_on_finite_bounds_as_residuals: _builtins.bool
    """See
    https://developers.google.com/optimization/lp/pdlp_math#treating_some_variable_bounds_as_infinite
    for a description of this flag.
    """
    use_diagonal_qp_trust_region_solver: _builtins.bool
    ...
    """
    diagonal_qp_trust_region_solver_tolerance: _builtins.float
    ...
    """
    use_feasibility_polishing: _builtins.bool
    ...
    @_builtins.property
    def random_projection_seeds(self) -> _containers.RepeatedScalarFieldContainer[_builtins.int]:
    ...
    def __init__(
        ...
        *,
        ...
        record_iteration_stats: _builtins.bool | None = ...,
        verbosity_level: _builtins.int | None = ...,
        log_interval_seconds: _builtins.float | None = ...,
        major_iteration_frequency: _builtins.int | None = ...,
        termination_check_frequency: _builtins.int | None = ...,
        restart_strategy: Global___PrimalDualHybridGradientParams.RestartStrategy.ValueType | None = ...,
        primal_weight_update_smoothing: _builtins.float | None = ...,
        initial_primal_weight: _builtins.float | None = ...,
        presolve_options: Global___PrimalDualHybridGradientParams.PresolveOptions | None = ...,
        l_inf_ruiz_iterations: _builtins.int | None = ...,
        l2_norm_rescaling: _builtins.bool | None = ...,
        sufficient_reduction_for_restart: _builtins.float | None = ...,
        necessary_reduction_for_restart: _builtins.float | None = ...,
